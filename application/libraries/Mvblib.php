...
class Mvblib
{
		...
		public function matchURL($getUserRolesa,$moduleId,$type)
		{
					...
					else
					{
							...
							$result_page_qry=$this->ci->db->query("SELECT mmap_id_pk from tblmvbmodulemapping where mmap_UsersId_fk='".$getUserRolesa."' AND mmap_module_id_fk='".$moduleId."' and mmap_client_id_fk='".$client_id."'");
					}
