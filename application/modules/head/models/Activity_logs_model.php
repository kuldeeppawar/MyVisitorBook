...

{
...

	{
				...
				$data=array('tl_admin_user_id_fk'=>$admin_user_id,'tl_type'=>$login_act,'tl_activity_time'=>$current_time,'tl_activity_details'=>$activity_details,'tl_ip_address'=>$user_ip);
