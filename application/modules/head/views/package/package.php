...
<div class="page-content-wrapper">
			...
			<div class="col-md-12">
				<div class=" app-ticket-list">
					<div class="page-bar row">
						<div class="col-md-6">
							<h3 class="page-title"><?php getLocalkeyword('New Package Management');?></h3>
							<ul class="page-breadcrumb ">
								...
								<li><span><?php getLocalkeyword('New Package Management');?></span></li>
							</ul>
						</div>
						<div class="col-md-6">
              ...
              <?php	
										...
										?>
						<!--modal-->
						<div id="addpackage" class="modal fade in" role="dialog">
								...
								<div class="modal-content">
									<div class="modal-header">
										...
										<h2 class="modal-title text-center">
											<i class="fa fa-plus"></i> Add Renewal Package
										</h2>
									</div>
													...
													<div class="row">
														<div class="col-md-5">
															<div class="form-group">
																<label class="">Package Type</label><br> <select class="form-control">
																	<option>Basic</option>
																	<option>SMS Recharge</option>
																	<option>Email Recharge</option>
														...
														<div class="col-md-5">
															<div class="form-group">
																<label class="">Package Name</label><br> <input type="text" class=" form-control" placeholder="">
															</div>
														</div>
														<div class="col-md-12">
															<div class="form-group">
																<label class="">Free SMS Credit</label><br>
																<div class="col-md-5 pl0">
																	<input type="text" class=" form-control" placeholder="Sms Per Unit">
																</div>
																<div class="col-md-5">
																	<input type="text" class=" form-control" placeholder="Total Price">
																</div>
																<div class="col-md-2 radio">
																	<label><input type="radio" name="optradio">NA</label>
																</div>
															</div>
														</div>
														<div class="col-md-12">
															<div class="form-group">
																<label class="">Free Email Credit</label><br>
																<div class="col-md-5 pl0">
																	<input type="text" class=" form-control" placeholder="Email Per Unit">
																</div>
																<div class="col-md-5">
																	<input type="text" class=" form-control" placeholder="Total Price">
																</div>
														...
														<div class="col-md-12">
															<div class="form-group">
																...
																<div class="col-md-3 pr0 ">
																	<a class="addmore"> <i class="fa fa-plus"></i> Add More
																	</a>
																</div>
														...
														<div class="col-md-12">
															<div class="form-group">
																...
																<div class="col-md-5">
																	<input type="text" class=" form-control" placeholder="Default Discount">
																</div>
															</div>
														</div>
														<div class="clearfix"></div>
														<br>
														<p class="col-md-12">
															<strong>Total Price with Discount 18000</strong>
														</p>
														<div class="col-md-12">
									...
									<div class="pull-right">
										<div style="float: left; margin-top: 8px; margin-right: 5px;">
										 ...
										 <?php
											...
											if (getAccessRights('mvbPmNpmEdit'))
											{
												?>
												<a id="editpackage" href="#" onclick="editPackage()" class="margin_rgt hide_element" data-toggle="modal" data-target="#addtax"> <i class="fa fa-pencil-square-o fa-2x" title="edit"
												style="color: #828282;"
											></i></a>
											<?php
											}
										...
										<?php
										if (getAccessRights('mvbPmNpmAdd'))
										{
											?>
									  <div class="btn-group">
											<a id="sample_editable_1_new hvr-float-shadow" href="<?php echo base_url()."head/package/addPackage"?>" class="btn btn-primary">
											<?php getLocalkeyword('Add New Package');?> </a>
										</div>
						    <?php
										}
										if (getAccessRights('mvbPmNpmActivate') || getAccessRights('mvbPmNpmDeactivate'))
										{
											?>
										<ul class="nav navbar-nav pl0 pull-right" style="margin-left: 5px;">
											...
											if (getAccessRights('mvbPmNpmActivate') || getAccessRights('mvbPmNpmDeactivate'))
											{
												?>
														<ul class="dropdown-menu dropdown-menu-default">
														<?php
												if (getAccessRights('mvbPmNpmActivate'))
												{
													?>		
												...
												if (getAccessRights('mvbPmNpmDeactivate'))
												{
													?>		
								...
								<table class="table table-striped table-bordered table-hover table-checkable order-column dataTable allchekbox" id="sample_1_2" role="grid" aria-describedby="sample_1_2_info">
										...
										<tbody>
										  <?php
											...
											<tr class="odd gradeX">
												<td><input name="chk<?php echo $j;?>" class="check_box" type="checkbox" data-ptag="sb1" id="chk<?php echo $j;?>" value="<?php echo base64_encode($result[$i]->pkg_id_pk) ;?>"></td>
												<td><?php echo $j;?></td>
												<td><?php echo $result[$i]->pkg_name;?></td>
												<td><?php echo $result[$i]->pkg_validity;?></td>
												<td><?php echo $result[$i]->pkg_smsCredit;?></td>
												<td><?php echo $result[$i]->pkg_emailCredit;?></td>
												<td><?php echo $result[$i]->pkgd_finalPrice;?> Rs.</td>
												<td><?php
													if ($result[$i]->pkg_status == "1")
													{
														?>
	...
	function chechCheckbox(id)
	{
	     ...
	     else
	     {
	          ...
	          $.post("<?php echo base_url();?>head/package/changepackageStatus",{id:id,package_id:package_id},function(data){
	...
	function editPackage()
	{
	     ...
	     else
	     {
	    	 ...
	    	 window.location.replace("<?php echo base_url()."head/package/editPackage/"?>"+package_id);
