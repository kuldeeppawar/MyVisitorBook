								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class=" app-ticket-list">
											<div class="page-bar row">
												<div class="col-md-6">
													<h3 class="page-title"><?php getLocalkeyword('Edit Client');?></h3>
													<ul class="page-breadcrumb ">
														<li><a href="<?php echo base_url()?>head/dashboard"><?php getLocalkeyword('Home');?></a> <i class="fa fa-circle"></i></li>
														<li><a href="<?php echo base_url()?>head/client_management"><?php getLocalkeyword('Client Management');?></a> <i class="fa fa-circle"></i></li>
														<li><span><?php getLocalkeyword('Edit Client');?></span></li>
													</ul>
												</div>
												<div class="col-md-6">
											...
											<div class="row">
												<div class="col-md-12">
													<form role="form" id="frmAdd" method="post" action="<?php echo base_url()?>head/client_management/editClient" enctype="multipart/form-data">
														<div class="form-body" style="padding-top: 10px;">
															<div class="row">
																<div class="col-md-3">
																	<div class="form-group">
																		<label><?php getLocalkeyword('Select Title');?><span class="mandatory">*</span></label> <select class="form-control" name="selTitle" id="selTitle" required="required">
																			...
																			<option value="Mr" <?php if($resultClient[0]->sysu_title=="Mr"){ echo "selected"; } ?>>Mr</option>
																			<option value="Miss" <?php if($resultClient[0]->sysu_title=="Miss"){ echo "selected"; } ?>>Miss</option>
																			<option value="Shri" <?php if($resultClient[0]->sysu_title=="Shri"){ echo "selected"; } ?>>Shri</option>
																		</select>
																	</div>
																</div>
																<div class="col-md-3">
																	<div class="form-group">
																		<div class="form-group">
																			<label><?php getLocalkeyword('First Name');?> <span class="mandatory">*</span></label> <input type="text" value="<?php echo $resultClient[0]->sysu_name;  ?>" class="form-control" placeholder="First name"
																				name="txtFirstname" id="txtFirstname" required="required"
																			> <input type="hidden" name="txtId" value="<?php echo $resultClient[0]->sysu_id_pk; ?>">
																...
																<div class="col-md-3">
																	<div class="form-group">
																		<div class="form-group">
																			<label><?php getLocalkeyword('Middle Name');?><span class="mandatory">*</span></label> <input type="text" class="form-control" value="<?php echo $resultClient[0]->sysu_mname;  ?>" placeholder="Middle Name"
																				name="txtMiddlename" id="txtMiddlename" required="required"
																			>
																		</div>
																	</div>
																</div>
																<div class="col-md-3">
																	<div class="form-group">
																		<div class="form-group">
																			<label><?php getLocalkeyword('Last Name');?> <span class="mandatory">*</span></label> <input type="text" class="form-control" value="<?php echo $resultClient[0]->sysu_lname;  ?>" placeholder="Last Name"
																				name="txtLastname" id="txtLastname" required="required"
																			>
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-md-3">
																	<div class="form-group">
																		<label><?php getLocalkeyword('Mobile Number');?><span class="mandatory">*</span></label> <input type="number" value="<?php echo $usercred['mobile'];  ?>" step="any" min="10" class="form-control"
																			placeholder="Mobile Number" name="txtMobilenumber" id="txtMobilenumber" required="required"
																		>
																	</div>
																</div>
																<div class="col-md-3">
																	<div class="form-group">
																		<label><?php getLocalkeyword('Email Id');?><span class="mandatory">*</span></label> <input type="email" value="<?php echo $usercred['email'];  ?>" class="form-control" placeholder="Email Id" name="txtEmail"
																		...
																		<div class="form-horizontal">
																			<div class="tab-content">
																					...
																					<div class="row">
																						<div class="col-md-6" style="border-right: solid 1px #eaeaea;">
																							<div class="form-group">
																								...
																								<div class="col-md-8">
																									<input type="text" value="<?php echo $resultClient[0]->sysu_address;  ?>" class="form-control" name="txtAddress" id="txtAddress" placeholder="Enter Your address"
																										required="required"
																									/>
																								</div>
																							</div>
																										...
																										<?php	
																										    ...
																										    {?>																					
																										      <option value="<?php echo $resultCountry[$i]->cntr_id_pk;?>"
																										           <?php if($resultClient[0]->sysu_countryId_fk==$resultCountry[$i]->cntr_id_pk){  echo "selected"; } ?>
																										           <?php if($resultCountry[$i]->cntr_status==0 && $resultClient[0]->sysu_countryId_fk!=$resultCountry[$i]->cntr_id_pk){  echo "disabled"; } ?>>	
																										...
																										<?php	
																										     ...
																										     { ?>
																										     	<option	value="<?php echo $resultState[$i]->stat_id_pk;?>"
																										     	     <?php if($resultClient[0]->sysu_stateId_fk==$resultState[$i]->stat_id_pk){ echo "selected";}	 
																										     	           if($resultState[$i]->stat_status==0 && $resultClient[0]->sysu_stateId_fk!=$resultState[$i]->stat_id_pk){  echo "disabled"; } ?>>
																								...
																								<div class="col-md-8">
																									<select class="form-control" name="selCity" id="selCity" required="required">
																										<option value="">Select City</option>
																										   <?php for($i=0;$i<count($resultCity);$i++)
																										      {?>
																										       	<option	value="<?php echo $resultCity[$i]->cty_id_pk;?>"
																											    <?php if($resultClient[0]->sysu_cityId==$resultCity[$i]->cty_id_pk){ echo "selected";}	
																											          if($resultCity[$i]->cty_status==0 && $resultClient[0]->sysu_cityId!=$resultCity[$i]->cty_id_pk){  echo "disabled"; } ?>>
																						...
																						<div class="col-md-6">
																							<div class="form-group">
																								...
																								<div class="col-md-8">
																									<input type="number" value="<?php echo $resultClient[0]->sysu_zipcode;  ?>" min="0" class="form-control" name="txtZip" placeholder="Enter Zip Code" required="required" />
																								</div>
																							</div>
																							<div class="form-group">
																								...
																								<div class="col-md-8">
																									<input type="text" class="form-control" value="<?php echo $resultClient[0]->sysu_website;  ?>" name="txtWebsite" placeholder="Enter your website URL" required="required" />
																								</div>
																							</div>
																							<div class="form-group">
																								...
																								<div class="col-md-8">
																									<input type="number" class="form-control" value="<?php echo $resultClient[0]->sysu_landline_no;  ?>" name="txtLandline" placeholder="Enter your Landline Number"
																										required="required"
																									/>
																								</div>
																							</div>
																							<div class="form-group">
																								...
																								<div class="col-md-8">
																									<input type="number" min="0" class="form-control" value="<?php echo $resultClient[0]->sysu_fax;  ?>" name="txtFax" placeholder="Enter your FAX Number" required="required">
																								</div>
																							</div>
																						</div>
																					</div>
																					...
																					<div class="row">
																						<div class="col-md-8">
																							<div class="form-group">
																								...
																								<div class="col-md-6">
																									<select class="form-control" name="selBusiness" id="selBusiness" required="required">
																										...
																										<option value="IT" <?php if($resultClient[0]->sysu_bussiness_category=="IT"){ echo "selected";}?>>IT</option>
																										<option value="Manufacturing" <?php if($resultClient[0]->sysu_bussiness_category=="Manufacturing"){ echo "selected";}?>>Manufacturing</option>
																										<option value="Logistick" <?php if($resultClient[0]->sysu_bussiness_category=="Logistick"){ echo "selected";}?>>Logistick</option>
																									</select>
																								</div>
																							</div>
																							<div class="form-group">
																								...
																								<div class="col-md-6">
																									<input type="text" class="form-control" value="<?php echo $resultClient[0]->sysu_bussiness_name;  ?>" placeholder="Enter Business Name" name="txtBusinessname"
																										required="required"
																									/>
																								</div>
																							</div>
																							<div class="form-group">
																								<label class="control-label col-md-5"><?php getLocalkeyword('Date Of Birth');?> <span class="required"> * </span>
																								</label>
																								<div class="col-md-6">
																									<div class="input-group input-medium date date-picker" data-date-end-date="+0d" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
																										<input type="text" value="<?php echo date(" d-m-Y ",strtotime($resultClient[0]->sysu_date_of_birth));?>" class="form-control" readonly name="txtBirtdate" required="required">
																							...
																							<div class="form-group">
																								...
																								<div class="col-md-6">
																									<div class="input-group input-medium date date-picker" data-date-end-date="+0d" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
																										<input type="text" class="form-control" value="<?php echo date(" d-m-Y ",strtotime($resultClient[0]->sysu_aniversary_date));?>" readonly name="txtAnniversary"
																											required="required"
																										> <span class="input-group-btn">
																											<button class="btn default" type="button">
																												<i class="fa fa-calendar"></i>
																				...
																				<div id="tab3" class="tab-pane fade">
																					<div class="fileinput-new  profile-userpic" style="height: 200px; width: 200px">
																						<img src="<?php echo base_url().'uploads/systemusers_images/'.$resultClient[0]->sysu_profile; ?>" alt="" />
																					</div>
																					<div class="profile-userbuttons col-md-6">
																						<label><?php getLocalkeyword('Upload Profile Pic');?></label> <input type="file" class="form-control col-md-3" name="txtFile"> <input type="hidden" class="form-control col-md-3" name="txtProfile"
																							value="<?php echo $resultClient[0]->sysu_profile; ?>"
																						>
																				...
																				<div id="tab4" class="tab-pane fade">
																					...
																					<div class="col-md-6">
																						<div class="form-group">
																							...
																							<textarea class="form-control" rows="3" placeholder="Type Here" name="txtInfo"><?php echo $resultClient[0]->sysu_Info; ?></textarea>
																						</div>
																					</div>
																					<div class="clearfix"></div>
																				</div>
																				<div id="tab5" class="tab-pane fade">
																					<h3 class="block"><?php getLocalkeyword('Provide your Additional Details');?></h3>
																					<div class="col-md-6">
																						<div class="form-group">
																							<label><?php getLocalkeyword('Enter Note');?></label>
																							<textarea class="form-control" rows="3" placeholder="Type Here" name="txtaddInfo"><?php echo $resultClient[0]->sysu_addInfo; ?></textarea>
																						</div>
																					</div>
																				</div>
																			</div>
																			<div class="row">
																				<div class="col-md-12">
																					<div class=" pull-right">
																						...
																						<a type="button" href="<?php echo base_url(); ?>head/client_management" class="btn btn-danger"><?php getLocalkeyword('Cancel');?></a>
																					</div>
																				</div>
																			</div>
																		</div>
																						...
																						<div class="row">
																							<div class="input-group col-md-6">
																								<div class="mt-checkbox-list">
																									<label class="mt-checkbox mt-checkbox-outline" id="advance" style="line-height: 16px; margin-bottom: 0px;"> <input type="checkbox" name="colorCheckbox" value="green"> Advance
																										your search <span></span>
																									</label>
																								</div>
																							</div>
														...
														<div class="page-quick-sidebar-chat-user">
															...
															<div class="page-quick-sidebar-chat-user-messages">
																...
																<div class="post out">
																	<img class="avatar" alt="" src="../assets/layouts/layout/img/avatar3.jpg" />
																	<div class="message">
																		<span class="arrow"></span> <a href="javascript:;" class="name">Bob Nilson</a> <span class="datetime">20:17</span> <span class="body"> Sure. I will check and buzz you if anything
																			needs to be corrected. </span>
																	</div>
																</div>
															</div>
