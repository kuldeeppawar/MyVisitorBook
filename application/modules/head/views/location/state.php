            ...
            <div class="col-md-12">
                <div class=" app-ticket-list">
                    <div class="page-bar row">
                        <div class="col-md-6">
                            <h3 class="page-title"><?php getLocalkeyword('State Management');?></h3>
                            <ul class="page-breadcrumb ">
                                <li><a href="<?php echo base_url()."head/dashboard";?>"><?php getLocalkeyword('Home');?> </a>  <i class="fa fa-circle"> </i>
                                </li>
                                <li><span> <a href="<?php echo base_url()."head/location";?>"><?php getLocalkeyword('Location Management');?> </a>
								</span>  <i class="fa fa-circle"> </i>
                                </li>
                                <li><span><?php getLocalkeyword('State Management');?> </span>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div id="prefix_834140561262" class="custom-alerts alert alert-success fade in ">
                            ...
                            <?php echo $this->session->tempdata('success');
                                  ...
                                  //$this->session->unset_userdata('assign_state_data');
                            ?>
                        </div>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" onclick="resetStateForm();">×</button>
                                        <h2 class="modal-title text-left">
											<i class="fa fa-plus"> </i> <?php getLocalkeyword('Add State');?>
										</h2>
                                    </div>
                                    <div class="modal-body">
                                        <div class="portlet-body form">
                                            <form role="form" id="frmAdd" method="post" action="<?php echo base_url()."head/location/addState "?>">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class=""><?php getLocalkeyword('State Name');?></label>
                                                        <br>
                                                        <input type="text" name="txtState" id="txtState" class="input-sm form-control " placeholder="Enter state name" required="required">
                                                        <input type="hidden" name="txtCountry" id="txtCountry" class="input-sm form-control " value="<?php echo $country_id;?>">
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="submit" name="submit" class="btn btn-primary"><?php getLocalkeyword('Save');?></button>
                                                        <button type="button" data-dismiss="modal" class="btn btn-danger" onclick="resetStateForm();"><?php getLocalkeyword('Cancel');?></button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h2 class="modal-title text-left">
											<i class="fa fa-plus"> </i> <?php getLocalkeyword('Edit State');?>
										</h2>
                                    </div>
                                    <div class="modal-body">
                                        <div class="portlet-body form">
                                            <form role="form" id="frmEdit" method="post" action="<?php echo base_url()."head/location/editState "?>">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class=""><?php getLocalkeyword('State Name');?></label>
                                                        <br>
                                                        <input type="text" name="txtEditstate" id="txtEditstate" class="input-sm form-control " placeholder="Enter state name" required="required">
                                                        <input type="hidden" name="txtEditstateid" id="txtEditstateid" class="input-sm form-control ">
                                                        <input type="hidden" name="txtCountry" class="input-sm form-control " value="<?php echo $country_id;?>">
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="submit" name="submit" class="btn btn-primary"><?php getLocalkeyword('Save');?></button>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="modal-footer"> 
                                                                        ...
                                                                        <a onclick="deleteState();" class="btn btn-primary"><?php getLocalkeyword('Yes');?></a>
                                    ...
                                    <div class="col-md-5  pull-right">
                                        <div class="pull-right">
                                            <div style="float: left; margin-top: 8px; margin-right: 5px;">
                                                <?php if(getAccessRights('mvbLocstEdit')) 
                                                      { ?>
		                                                <a href="#" onclick="get_record()" class="margin_rgt hide_element" style="visibility: hidden;" data-toggle="modal" data-target="#addFestival1"> <i class="fa fa-pencil-square-o fa-2x" title="edit" style="color: #828282;"> </i>
		                                                </a>
                                                 <?php } 

                                                      if(getAccessRights('mvbLocstDelete'))
                                                      {   
                                                      ?>
								     ...
								     <i class="fa fa-trash fa-2x" title="Delete" style="color: #828282;"></i>
                                            ...
                                            <div class="btn-group">
                                            <?php
                                            if(getAccessRights('mvbLocstDownload'))
                                            {
                                            ?>
												<a id="sample_editable_1_new hvr-float-shadow" data-toggle="modal"  class="btn btn-danger"  data-target="#otp1" onclick="getOTP('<?php echo $country_id;?>');"><i
													class="fa fa-cloud-download"
												></i>Download State CSV</a>
                                            <?php
                                            }
                                            ?>    
					                        </div>   
                                            <?php 
                                            if(getAccessRights( 'mvbLocstAdd')) 
                                            { ?>
                                            <div class="btn-group">
                                                <a id="sample_editable_1_new hvr-float-shadow" data-toggle="modal" data-target="#addFestival" class="btn btn-primary">
                                                   <?php getLocalkeyword('Add State');?>
                                                </a>
                                            </div>
                                            <?php 
                                            } 
                                            if (getAccessRights( 'mvbLocstActivate') || getAccessRights( 'mvbLocstDeactivate'))
                                            { ?>
                                            <ul class="nav navbar-nav pl0 pull-right" style="margin-left: 5px;">
                                                <li class="dropdown dropdown-user burger_menu">
                                                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" style="margin-top: 0px;">
                                                        <i class="fa fa-bars fa-2x" aria-hidden="true"> </i>
                                                    </a>
                                                    <?php if(getAccessRights( 'mvbLocstActivate') || getAccessRights( 'mvbLocstDeactivate') ) { ?>
                                                    <ul class="dropdown-menu dropdown-menu-default">
                                                        <?php if(getAccessRights( 'mvbLocstActivate')) { ?>
                                                        ...
                                                        <?php } if(getAccessRights( 'mvbLocstDeactivate')) { ?>
                                                        <li class="options">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable allchekbox" id="sample_1_2" role="grid" aria-describedby="sample_1_2_info">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    <td>
                                                        <input name="chk<?php echo $j;?>" class="check_box" type="checkbox" data-ptag="sb1" id="chk<?php echo $j;?>" value="<?php echo $result[$i]->stat_id_pk;?>">
                                                    </td>
                                                    <td>
                                                        <?php echo $j;?>
                                                    </td>
                                                    <td>
                                                        <?php echo $result[$i]->cntr_name;?>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo base_url()."head/location/getallCity/".base64_encode($result[$i]->stat_id_pk)."/".base64_encode($country_id);?>">
                                                            <?php echo $result[$i]->stat_name;?>
                                                        </a>
                                                        <input type="hidden" id="state_list<?php echo $j;?>" value="<?php echo $result[$i]->stat_name; ?>">
                                                        <input type="hidden" id="state_id<?php echo $j;?>" value="<?php echo $result[$i]->stat_id_pk; ?>">
                                                    </td>
                                                    <td>
                                                        <?php echo date( "d-m-Y H:i:s", strtotime($result[$i]->stat_createdDate));?>
                                                    </td>
                                                    <td>
                                                        <?php echo $result[$i]->created_by;?>
                                                    </td>
                                                    <td>
                                                        <?php echo date( "d-m-Y H:i:s", strtotime($result[$i]->stat_modifiedDate));?>
                                                    </td>
                                                    <td>
                                                        <?php echo $result[$i]->modified_by;?>
                                                    </td>
                                                    <td>
                                                        <?php if($result[$i]->stat_status==1) { ?>
  ...
  location.reload();
    ...
    function get_record() {
        ...
        for (var i = 1; i <= count; i++) {
            if ($('#chk' + i).is(':checked')) {
                country = $("#chk" + i).val();
                var txtState = $("#state_list" + i).val();
                var txtStateid = $("#state_id" + i).val();
                $('#txtEditstateid').val(txtStateid);
                $('#txtEditstate').val(txtState);
            }
        }
    }
    ...
    function chechCheckbox(id) {
        ...
        for (var i = 1; i <= count; i++) {
            if ($('#chk' + i).is(':checked')) {
                state.push($("#chk" + i).val());
            }
        }
        if (state.length === 0) {
            alert("Please select the state name");
        } else {
            $.post("<?php echo base_url();?>head/location/changestateStatus", {
                id: id,
                state: state
            }, function(data) {
                //alert(data);
...
$("#otp_verify_form").validate({
    ...
    function deleteState()
    {
                     ...
                     for (var i=0;i<=count;i++)
                     {
                          if($('#chk'+i).is(':checked'))
                          {
                              stateid.push($("#chk"+i).val());                              
                          }
                     } 
                                          
                    $.post("<?php echo base_url();?>head/location/deleteState",{state_id:stateid},function(data){                            
                              location.reload(true);
                         });                                                 
    }
                    ...
                    <div class="page-quick-sidebar-chat-user">
                        ...
                        <div class="page-quick-sidebar-chat-user-messages">
                            ...
                            <div class="post out">
                                <img class="avatar" alt="" src="../assets/layouts/layout/img/avatar3.jpg" />
                                <div class="message">
                                    <span class="arrow"> </span>  <a href="javascript:;" class="name">Bob Nilson </a>  <span class="datetime">20:17 </span>  <span class="body"> Sure. I will check and buzz you if anything needs to
										be corrected. </span>
                                </div>
                            </div>
                        </div>
