			...
			<div class="col-md-12">
				<div class=" app-ticket-list">
					<div class="page-bar row">
						<div class="col-md-6">
							<h3 class="page-title"><?php getLocalkeyword('Keyword Management');?></h3>
							<ul class="page-breadcrumb ">
								<li><a href="<?php echo base_url()."head/dashboard ";?>"><?php getLocalkeyword('Home');?></a> <i class="fa fa-circle"></i></li>
								<li><span><?php getLocalkeyword('Keyword Management');?></span></li>
							</ul>
						</div>
						<div class="col-md-6">
									...
									<div class="modal-dialog">
										...
										<div class="modal-content">
											<div class="modal-header"> <button type="button" class="close" data-dismiss="modal">×</button>
												<h2 class="modal-title text-left"> <i class="fa fa-plus"></i><?php getLocalkeyword('Add Keyword');?>  </h2>
											</div>
											<div class="modal-body">
												<div class="portlet-body form">
													<form role="form" id="frmAdd" method="post" action="<?php echo base_url()."head/localization/addKeyword "?>">
														<div class="form-body">
															<div class="form-group"> <label class=""><?php getLocalkeyword('Keyword Name');?></label> <br> 
															<input type="text" name="keyword" class="input-sm form-control " placeholder="insert Kewyword" required="required"> 
															</div>
								...
								<div id="addFestival1" class="modal fade in" role="dialog">
									<div class="modal-dialog">
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<div class="portlet-body form">
													<form role="form" method="post" id="frmEdit" action="<?php echo base_url()."head/localization/editKeyword "?>">
														<div class="form-body">
															<div class="form-group"> <label class=""><?php getLocalkeyword('Keyword Name');?></label> <br> 
								...
								<!--end modal-->
								  <div id="otpimport" class="modal fade in" role="dialog">
											...
											<div id="import" class="modal fade" role="dialog">
												...
												<div id="importKey" class="modal fade" role="dialog">
												<div class="modal-dialog">
													<div class="col-md-10">
														<div class="modal-content">
															<div class="modal-header">
																<button type="button" class="close" data-dismiss="modal">&times;</button>
																<h2 class="modal-title text-left"><?php getLocalkeyword('Upload Keyword CSV');?></h2>
															</div>
															<div class="modal-body">
																<div class="portlet-body form">
																	<form role="form"  action="<?php echo base_url()?>head/localization/uploadCsv" method="post" enctype="multipart/form-data">
																		<div class="form-body">
																			<div class="row">
																				<div class="col-md-12">
																				<div class="form-group"> <label class=""><?php getLocalkeyword('Language');?></label> <br> 
																				<select class="input-sm form-control" name="selLanguage" id="selLanguage" required="required">
																				 ...
																				 ?>
																					...
																					<a onclick="getkeySamplecsv()" href="#"><?php getLocalkeyword('Download Sample CSV');?></a>
																					<div class="modal-footer">
										...
										<div class="row">
											...
											<div class="col-md-5  pull-right">
												<div class="pull-right">
													...
													<?php
													if(getAccessRights('mvbSetMultiImport'))
													{
													?>	
													...
													<?php
													if(getAccessRights('mvbSetMultiExport'))
													{
													?>	
											...
											if (getAccessRights('mvbSetMultiEdit'))
											{
												?>
											...
											?> </div>
											<?php
											if (getAccessRights('mvbSetMultiUpload'))
											{
												?>
														<div class="btn-group"> <a id="sample_editable_1_new hvr-float-shadow" data-toggle="modal" data-target="#importKey" class="btn btn-primary"><?php getLocalkeyword('Upload CSV');?></a> </div>
														<?php
											}
												?>
											<?php
											if (getAccessRights('mvbSetMultiAdd'))
											{
												?>
													...
													<tbody>
														<?php
															for($i=0;$i < count($result);$i ++)
															{
																...
																?>
																			<tr class="odd gradeX">
																				<td><input name="chk<?php echo $j;?>" class="check_box" type="checkbox" data-ptag="sb1" id="chk<?php echo $j;?>" value="<?php echo $result[$i]->keywd_id_pk;?>"></td>
																				<td>
																					<?php echo $j;?> </td>
																				<td><a href="<?php echo base_url()."head/localization/getLocalkeywords/".base64_encode($result[$i]->keywd_id_pk);?>"><?php echo $result[$i]->kewd_name;?> </a> 
																				<input type="hidden" id="keyword_list<?php echo $j;?>" value="<?php echo $result[$i]->kewd_name; ?>"> 
																				<input type="hidden" id="keyword_id<?php echo $j;?>" value="<?php echo $result[$i]->keywd_id_pk; ?>"></td>
																				<td>
																					<?php echo date("d-m-Y H:i:s", strtotime($result[$i]->kewd_createdDate));?> 
																				</td>
...
{  <?php $url= base_url().'uploads/csvsample/keywordsample.csv';?>
	window.open("<?php echo  $url;?>", "_blank");
}



function getkeySamplecsv()
{  <?php $url= base_url().'uploads/csvsample/keywordslist.csv';?>
	window.open("<?php echo  $url;?>", "_blank");
}
