  ...
  <li><a data-toggle="tab" href="#password">Change Password</a></li> -->
							...
							<div class="tab-content">
								<div id="password" class="tab-pane fade in active">
									<form id="password_change_form" name="password_change_form" method="POST" action="<?php echo base_url();?>head/user_management/changeOtp">
										<div class="row">
											<div class="col-md-2"></div>
											<div class="col-md-8">
												<div class="row">
													<div class="col-md-12 form-group">
														<label><?php getLocalkeyword('New Password');?></label> <input type="password"  id="txtPassword" class="form-control input-sm" name="txtPassword" placeholder="Enter New password">
													</div>
													<br> <br> <br>
													<div class="col-md-12 form-group">
														<label><?php getLocalkeyword('Confirm Password');?></label> <input type="password" id="txtcPassword" class="form-control input-sm" name="txtcPassword" placeholder="Confirm New password">
													</div>
												</div>
											</div>
											<div class="col-md-2"></div>
										...
										<div class="row">
											...
											<div class="col-md-5">
												...
												<div class="col-md-12 form-group">
													...
													<a href="<?php echo base_url()?>head/user_management/userProfile"><button type="button" class="btn btn-danger"><?php getLocalkeyword('Cancel');?></button></a>
												</div>
											</div>
											<div class="col-md-3"></div>
										</div>
...
<script type="text/javascript">
      ...
      var password = $("#txtPassword").val();
		...
		function ValidateOtp()
		{
           ...
           if(Password1!="")
           {
	            if( Password1==Password  && Password!="" && Password1!="")
			    {
			           var Password=Password1;
			        
			     	   $.post("<?php echo base_url();?>head/user_management/changeOtp",{Password},function(data)
			     	   {
		                    ...
		                    if(data==1)
		                    	...
		                    	window.location = "<?php echo base_url()?>head/user_management/userProfile";
