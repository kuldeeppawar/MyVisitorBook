 <div class="page-content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class=" app-ticket-list">
                              ...
                              <button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>
                                            <?php echo $this->session->tempdata('error');?></div>
                                        <?php } ?>
                                                ...
                                                <div class="col-md-5  pull-right">
                                                    ...
                                                    <div class="pull-right">
                                                        ...
                                                        <div style="float: left; margin-top: 8px; margin-right: 5px;">
                                                            ...
                                                            <?php
                                                              if(getAccessRights('mvbUmUtEdit'))
                                                              {
                                                            ?> 
                                                                   <a class="margin_rgt hide_element" id="edit_user_type_anchor"> <i class="fa fa-pencil-square-o fa-2x" title="Edit" style="color:#828282; "></i></a>
                                                            <?php 
                                                            }
                                                            ?> 
                                                        ...
                                                        <?php
                                                            if(getAccessRights('mvbUmUtAdd'))
                                                            {
                                                        ?> 
                                                                  <div class="btn-group"> <a href="<?php echo base_url();?>head/user_management/addUserType" class="btn btn-primary"><?php getLocalkeyword('Add New User Type');?></a></div>
                                                        <?php      
                                                            }

                                                            if(getAccessRights('mvbUmUtActive') || getAccessRights('mvbUmUtDeactive'))
                                                            {
                                                        ?>
                                                              ...
                                                              ?>
                                                                      <ul class="dropdown-menu dropdown-menu-default">
                                                                      <?php
                                                                        if(getAccessRights('mvbUmUtActive'))
                                                                        {
                                                                      ?>    
                                                                            <li class="options" style="border-bottom: 1px solid #e7ecf1;"> <a title="Custom Fields" style="padding: 5px; margin-top: 5px;" onclick="chechCheckbox(1);">
                                                                            <?php getLocalkeyword('Active');?></a></li>
                                                                      <?php
                                                                        }

                                                                        if(getAccessRights('mvbUmUtDeactive'))
                                                                        {  
                                                                      ?>      
                                                                            <li class="options"> <a title="Custom Fields" style="padding: 5px; margin-top: 5px; " onclick="chechCheckbox(0);">
                                                        ...
                                                        <?php
                                                         ...
                                                         ?>
                                                                    <tr class="odd gradeX">
                                                                            ...
                                                                            <td>
                                                                                <input name="chk1" class="check_box" type="checkbox" data-ptag="sb1" id="chk<?php echo $j;?>" value="<?php echo $result[$ut]->mutyp_id_pk;?>"onclick="edit_user_type();">
                                                                            </td>

                                                                            <td><?php echo $j;?></td>

                                                                            <td><?php echo $result[$ut]->mutyp_userType;?></td>
            ...
            <script type="text/javascript">
                   function edit_user_type()
                   {
                            ...
                            $("#edit_user_type_anchor").attr("href", "<?php echo base_url();?>head/user_management/editUserType/"+window.btoa(sender_id));
                   ...
                   function chechCheckbox(id)
                    {
                         ...
                         {
                              $.post("<?php echo base_url();?>head/user_management/changeUserTypeIdStatus",{id:id,user_type_id:usertypeid},function(data){
                                  location.reload(true);
                                   });
