            ...
            <div class="col-md-12">
                <div class=" app-ticket-list">
                    <div class="page-bar row">
                        <div class="col-md-6">
                            <h3 class="page-title"><?php getLocalkeyword('SMS Template Request');?></h3>	
                            <ul class="page-breadcrumb ">
                                <li><a href="<?php echo base_url()?>head/dashboard"><?php getLocalkeyword('Home');?></a>  <i class="fa fa-circle"></i>
                                </li>
                                <li><a href="#"><?php getLocalkeyword('Approval Management');?></a>  <i class="fa fa-circle"></i>
                                </li>
                                <li><span><?php getLocalkeyword('SMS Template Request');?></span>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <div id="reportrange" class="btn pull-right " style="padding-top: 12px;">	<i class="fa fa-calendar"></i> &nbsp; <span class="thin uppercase hidden-xs">August 28, 2016 - September 26, 2016</span>  <b class="fa fa-angle-down"></b>	
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div id="reject_comment" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                        <h4 class="modal-title text-center"><?php getLocalkeyword('Add Comment');?></h4>	
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5  pull-right">
                                        <div class="pull-right">
                                            ...
                                            <?php if (getAccessRights( 'mvbAmStrApprove') || getAccessRights( 'mvbAmStrReject')) { ?>
                                            <ul class="nav navbar-nav pl0 pull-right" style="margin-left: 5px;">
                                                <li class="dropdown dropdown-user burger_menu">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-default">
                                                        <?php if (getAccessRights( 'mvbAmStrApprove')) { ?>
                                                        <li class="options" style="border-bottom: 1px solid #e7ecf1;"><a id="approve_popup" data-toggle="modal" title="Approve" onclick="checkCB('approve');" style="padding: 5px; margin-top: 5px;"><?php getLocalkeyword('Approve');?></a>
                                                        </li>
                                                        <?php } if (getAccessRights( 'mvbAmStrReject')) { ?>
                                                        <li class="options"><a id="reject_popup" data-toggle="modal" title=" Reject" style="padding: 5px; margin-top: 5px;" onclick="checkCB('reject');"><?php getLocalkeyword('Reject');?></a>
                                                        </li>
                                                        <?php } ?>
                                                    </ul>
                                                    <?php } ?>
                                ...
                                <div class="portlet light">
                                    <div class="portlet-body">
                                       <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable allchekbox" id="sample_1_2" role="grid" aria-describedby="sample_1_2_info">
                                            ...
                                            <tbody>
                                                <?php for($st=0;$st < count($result);$st ++) { $mu=$st + 1; ?>
                                                <tr class="odd gradeX">
                                                    <td>
                                                        <input name="chk1" class="check_box" type="checkbox" data-ptag="sb1" id="chk<?php echo $mu;?>" value="<?php echo $result[$st]->str_id_pk;?>">
                                                    </td>
                                                    <td>
                                                        <?php echo $mu;?>
                                                    ...
                                                    <td>
                                                        <?php echo $result[$st]->clnt_name;?></td>
                                                    <td>
                                                        <?php echo $result[$st]->requested_date;?></td>
                                                    <td>
                                                        <?php echo $result[$st]->str_template_name;?></td>
                                                    <td>
                                                        <?php echo substr($result[$st]->str_description,0,150).'...';?></td>
                                                    <td>
                                                        <?php  echo $result[$st]->app_rejt_date; ?></td>
                                                    <td>
                                                        <?php echo ucfirst($result[$st]->str_admin_status);?> <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="<?php echo $result[$st]->str_comment;?>">														 </i>	
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
...
<script>
    function setStatus(value) {
        ...
        if (sms_temp_id.length === 0) {
            ...
            $.post('<?php echo base_url()."head/sms_temp_request/setStatus";?>', {
                type: value,
    ...
    function checkCB(type) {
        ...
        if (sms_temp_id.length === 0) {
            alert("Please select sms template name");
        } else {
            if (type == 'approve') {
