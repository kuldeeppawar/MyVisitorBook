			...
			<div class="col-md-12">
				<div class=" app-ticket-list">
					<div class="page-bar row">
						<div class="col-md-6">
							<h3 class="page-title"><?php getLocalkeyword('Email Templates');?></h3>
							<ul class="page-breadcrumb ">
								<li><a href="<?php echo base_url()?>head/dashboard"><?php getLocalkeyword('Home');?></a> <i class="fa fa-circle"></i></li>
								<li><span><?php getLocalkeyword('Email Templates');?></span></li>
							</ul>
						</div>
						<div class="col-md-6">
							...
							<div class="table-toolbar">
									...
									<div class="col-md-5  pull-right">
										<div class="pull-right">
											<div style="float: left; margin-top: 8px; margin-right: 5px;">
								             ...
								             <?php if(getAccessRights('mvbEtmEdit'))
													{
													?>
													...
													if(getAccessRights('mvbEtmPush'))
													{
													?>
														<a href="#" class="margin_rgt hide_elementp db_click" onclick="submitPushrevoke('1')">
														 <i class="fa fa-mail-forward fa-2x"  title="Push" style="color: #828282;"></i></a>
													<?php
													}

													if(getAccessRights('mvbEtmRevoke'))
													{
													?>	 
														 <a href="#" class="margin_rgt hide_elementp db_click" onclick="submitPushrevoke('0')"> 
														 <i class="fa fa-mail-reply fa-2x" title="Revoke" style="color: #828282;"></i></a>
													<?php
													}

													if(getAccessRights('mvbEtmDelete'))
													{
													?>	 
												...
												<!--<a href="#" class="margin_rgt hide_element"> Import</a> -->
											</div>
											 <?php
										if(getAccessRights('mvbEtmAdd'))
										{
									    ?>
												 <div class="btn-group">
															<a id="email_template" class="btn btn-primary">
															<?php getLocalkeyword('Add Template');?></a>
														</div>
									    <?php		
										}
						              	if(getAccessRights('mvbEtmActive') || getAccessRights('mvbEtmDeactive') )
											{
								?>
										<ul class="nav navbar-nav pl0 pull-right" style="margin-left: 5px;">
											<li class="dropdown dropdown-user burger_menu"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"
												...
												<?php
												if(getAccessRights('mvbEtmActive') || getAccessRights('mvbUmMuDeactive') )
												{
												?>
														<ul class="dropdown-menu dropdown-menu-default">
														<?php
															if(getAccessRights('mvbEtmActive'))
															{
														?>		
														...
														<?php
															...
															if(getAccessRights('mvbEtmDeactive'))
															{
														?>		
								...
								<div class="selected_rows">
									<font id="show_checkbox_selected"></font>
									 <a id="selectall">
									 <?php getLocalkeyword('select all');?></a>
								</div>
										...
										<table class="table table-striped table-bordered table-hover table-checkable order-column dataTable allchekbox" id="sample_1_2" role="grid" aria-describedby="sample_1_2_info">
											<thead>
												<tr>
													...
													<th><?php getLocalkeyword('Subject');?></th>
											 ...
											 ?>
												<tr class="odd gradeX">
													<td><input name="chk<?php echo $j;?>" class="check_box" type="checkbox" data-ptag="sb1" id="chk<?php echo $j;?>"
													    value="<?php echo $resultTemplate[$i]->email_id_pk;?>"></td>
													<td><?php echo $j;?></td>
													...
													<td>
													<?php
													if(getAccessRights('mvbEtmEdit'))
													{
													?>
													<a onclick="getTemplate('<?php echo $resultTemplate[$i]->email_id_pk;?>')"><?php echo $resultTemplate[$i]->email_templateName;?></a>
													<?php
													}
													else
													{
													?>
													<a href="#"><?php echo $resultTemplate[$i]->email_templateName;?></a>
													<?php
                                                      }?>
													</td>
													<td>
													     ...
													     <?php 
													        if($resultTemplate[$i]->email_status==1)
													        {
				...
				<div class="portlet light bordered">
					<div class="portlet-title1">
						...
						<div class="icone_place">
							<a data-toggle="modal" class="margin_rgt" style="padding-top: 7px; "  data-target="#delete"> <i id="show_delete_div" class="fa fa-trash fa-2x" title="Delete" style="color: #828282; visibility: hidden;" ></i></a>
							<?php
							if(getAccessRights('mvbEtmPush') || getAccessRights('mvbEtmRevoke'))
							{
							?>
							<ul class="nav navbar-nav pl0 pull-right" style="margin-left: 5px;display:none;" id="show_pushrevoke_div">
								<li class="dropdown dropdown-user burger_menu"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"
									...
									{
									?>	
										<li class="options" style="border-bottom: 1px solid #e7ecf1;"><a href="#" style="padding: 5px; margin-top: 5px;" onclick="setPushRevoke('1');">
									...
									{
									?>	
										<li class="options"><a href="#"  style="padding: 5px; margin-top: 5px;" onclick="setPushRevoke('0');">
						...
						<ul class="list list-group All_list">
							 <?php 
								  for($i=0;$i<count($resultTemplate);$i++)
								  {
								  	 $j=$i+1;
								 ?>
							<li class="list-group-item"><input class="check_boxedit" name="chkProfile<?php echo $j;?>" id="chkProfile<?php echo $j;?>" onclick="getTemplatelist('<?php echo $resultTemplate[$i]->email_id_pk;?>',this.id)"
							               type="checkbox" height="20" width="20" value="<?php echo $resultTemplate[$i]->email_id_pk;?>" /> <?php echo $resultTemplate[$i]->email_templateName;?></li>
			...
			<div class="col-md-8">
				<div class="row">
					<div class="" style="margin-bottom: 10px; padding: 10px 0px; margin-left: 12px; margin-right: 12px;">
						 <a class="close_section pull-right" title="Close" >
						      <i data-toggle="modal" data-target="#delete" class="fa fa-trash fa-2x" title="Delete" style="color: #828282; cursor: pointer;visibility: hidden;" id="delete_emailtemp_id" ></i> <i id="close"
							onclick="closProfileDiv();" style="color: #616161; padding-top: 10px;" class="fa fa-times fa-3x"></i>
						</a>
					</div>
				</div>
				<form action="<?php echo base_url()?>head/emailtemplate/addTemplate" method="post" id="frmTemplate">
				<div class="row">
					...
					<div class="col-md-6 ">
						<div class=" form-group">
							<label class=""><?php getLocalkeyword('Select Festival');?></label>
							 <select class="form-control" name="selFestival" id="selFestival" onchange="getFestivaldate(this.value)" required="required">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label class=""><?php getLocalkeyword('Email Template Name');?></label>
							 <input type="text" name="txtTemplatename" id="txtTemplatename" class=" input-sm form-control " placeholder="" required="required">
					...
					<div class="col-md-12">
						...
						<label class=""><?php getLocalkeyword('Email Template Content');?></label>
							<textarea name="summernote_1" class="summernote" id="summernote_1" rows="6" cols="6" required></textarea>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<a onclick="closProfileDiv();" class="btn btn-danger"><?php getLocalkeyword('Cancel');?></a>
						</div>
					</div>	
				</form>
			</div>
...
<script>
	...
	{
			$.post("<?php echo base_url();?>head/emailtemplate/getFestivalDetails",{stateId:state_id},function(data){
				  $("#txtFestivaldate").val('');		
     ...
     function closProfileDiv()
     {
	     ...
	     $('#frmTemplate').attr('action', '<?php echo base_url();?>head/emailtemplate/addTemplate');
	...
	$(document).ready(function(){
	   ...
	   $(".page-content-wrapper1").hide();
	    ...
	    $("#email_template,#edit1,#msg_detail1,#msg_detail2,#msg_detail3").click(function(){
	...
	function chechCheckbox(id)
	{
	     ...
	     {
	          $.post("<?php echo base_url();?>head/emailtemplate/changetemplateStatus",{id:id,template:template},function(data){
	              location.reload(true);
	               });    
	      }  
	} 
	...
	function submitPushrevoke(id)
	{
	     ...
	     {
	          $.post("<?php echo base_url();?>head/emailtemplate/submitPushrevoke",{id:id,template:template},function(data){
	          	//console.log(data);
	              location.reload(true);
	               });	          
	      }  
	...
	function getTemplate(id)
	{
		   ...
		   $.post("<?php echo base_url();?>head/emailtemplate/getTemplate",{id:id},function(data){
                 ...
                 $.post("<?php echo base_url();?>head/emailtemplate/getFestivalDetails",{stateId:arr.state},function(data){
	              $("#selFestival").html(data);
                 ...
                 $('#summernote_1').html(arr.description);
                 
                 $('#delete_emailtemp_id').css('visibility','visible');
                
               });

		       $('#frmTemplate').attr('action', '<?php echo base_url();?>head/emailtemplate/editTemplate');
	...
	{
			$("#delete_temp_func").attr('onclick',"deleteETM()");	
	}
	...
	function deleteETM()
	{
		    ...
		    $.post("<?php echo base_url();?>head/emailtemplate/deleteETM",{template_id:template},function(data){
	              location.reload(true);
	               });
	}
	...
	function setPushRevoke(id)
	{
		    ...
		    $.post("<?php echo base_url();?>head/emailtemplate/submitPushrevoke",{id:id,template:template_ids},function(data){
	              location.reload(true);
	               });
	}

	function deleteSelectedETM()
	{
			var count='<?php echo count($resultTemplate)?>';
		     var template;
