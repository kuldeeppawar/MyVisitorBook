			...
			<div class="col-md-12">
				<div class=" app-ticket-list">
					<div class="page-bar row">
						<div class="col-md-6">
							<h3 class="page-title"><?php getLocalkeyword('OPT Request');?></h3>
							<ul class="page-breadcrumb ">
								...
								<li><span><?php getLocalkeyword('OPT Request');?></span></li>
							</ul>
						</div>
						<div class="col-md-6">
							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title text-leftr"><?php getLocalkeyword('Edit OPT Name');?></h4>
									</div>
									<form id="opt_request_form" name="opt_request_form" action="<?php echo base_url();?>head/OPT_request/editOPTName" method="POST">
										<div class="modal-body">
											...
											<div class="row">
												<div class="col-md-1"></div>
												<div class="col-md-11">
													<input type="hidden" id="hidden_opt_id" name="hidden_opt_id" value="hidden_opt_id" /> <a href="#" style="margin-left: 10px;">
								...
								<div class="row">
									...
									<div class="col-md-5  pull-right">
										<div class="pull-right">
											...
											{
												?>    
                                                    <a data-target="#edit_data_popup" data-toggle="modal" class="margin_rgt hide_element" onclick="setoptname();"> <i
											...
											{
												?>        
                                                    <a id="approve_popup" data-toggle="modal" title="Approve" style="padding: 5px; margin-top: 5px;" onclick="checkCB('1');"><i
													class="fa fa-2x fa-thumbs-o-up" aria-hidden="true" style="color: #828282;">
												</i></a>
                                            <?php
											}
											...
											{
												?>
                                                    <a id="reject_popup" data-toggle="modal" title="Reject" style="padding: 5px; margin-top: 5px;" onclick="checkCB('2');"><i class="fa fa-2x fa-ban"
													aria-hidden="true" style="color: #828282;">
												</i></a>
                                            <?php
											}
											?>        
										...
										<table class="table table-striped table-bordered table-hover table-checkable order-column dataTable allchekbox" id="sample_1_2" role="grid" aria-describedby="sample_1_2_info">
											<thead>
												<tr>
													...
													<th><?php getLocalkeyword('OPT Name');?></th>
											...
											<tbody>
                                                <?php
												   ...
												   ?>
			                                                    <tr class="odd gradeX">
																<td><input name="chk1" class="check_box" type="checkbox" data-ptag="sb1" id="chk<?php echo $mu;?>" value="<?php echo $result[$st]->optreq_id_pk;?>"></td>
																<td>   <?php echo $result[$st]->clnt_name;?>  </td>
																<td>   <?php echo $result[$st]->requested_date;?> </td>
																<td>   <?php echo $result[$st]->created_date;?> </td>
																<td>   <?php echo '-';?> </td>
																<td>   <?php echo $result[$st]->optreq_opt_name;?></td>
																<td>   <?php  
																				echo $result[$st]->app_rejt_date;
																			
																		?>
			                                                        </td>
																<td>
			                                                            <?php echo $result[$st]->request_status;?> 
			                                                             <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top"
																								title="<?php echo $result[$st]->optreq_comment;?>">
																			</i>
															   </td>
															</tr>
                                                    <?php
