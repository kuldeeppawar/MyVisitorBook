			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 blue" href="#">
						...
						<div class="details">
							<div class="number">
								<span data-counter="counterup" data-value="500">500</span>
							</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<a class="dashboard-stat dashboard-stat-v2 red" href="#">
						...
						<div class="details">
							<div class="number">
								<span data-counter="counterup" data-value="500">500 
					...
					<li class="panel1 col-md-6">
						<form>
							...
							<div class="row">
								...
								<div class="col-md-4 form-group">
									<input type="text" class="form-control" placeholder="Anniversary Date">
								</div>
							</div>
							<div class=" form-group">
								<textarea class="form-control" rows="3" placeholder=" Note">                                                   </textarea>
							</div>
							<button class="btn btn-danger pull-right" style="margin-top: 8px;">Save</button>
						</form>
					</li>
					<li class="panel1 col-md-6">
						<form>
							...
							<div class=" form-group">
								<textarea class="form-control" rows="9" placeholder=" Purpose">                                                   </textarea>
							</div>
							<button class="btn btn-danger pull-right">Track</button>
						</form>
					</li>
					<li class="panel1 col-md-6">
						<h4 class="text-center panel-heading1" style="color: #000">
