...

{
...

	{
				...
				$data=array('atl_admin_user_id_fk'=>$admin_user_id,'atl_branch_id_fk'=>$branch_id,'atl_type'=>$login_act,'atl_activity_time'=>$current_time,'atl_activity_details'=>$activity_details,'atl_ip_address'=>$user_ip);
