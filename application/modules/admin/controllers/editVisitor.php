								...
								<div class="form-body" style="padding-top: 10px;">
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												<div class="form-group">
													<label>First name <span class="mandatory">*</span></label> <input type="text" value="<?php echo $resultVisitor[0]->vis_firstName;  ?>" class="form-control"
										...
										<div class="col-md-3">
											<div class="form-group">
												<div class="form-group">
													<label>Middle Name <span class="mandatory">*</span></label> <input type="text" class="form-control" value="<?php echo $resultVisitor[0]->vis_middleName;  ?>"
										...
										<div class="col-md-3">
											<div class="form-group">
												<div class="form-group">
													<label>Last Name <span class="mandatory">*</span></label> <input type="text" class="form-control" value="<?php echo $resultVisitor[0]->vis_lastName;  ?>"
									...
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
												<label>Mobile Number <span class="mandatory">*</span></label> <input type="number" value="<?php echo $resultVisitor[0]->vis_mobile;  ?>" step="any" min="10"
												 class="form-control" placeholder="Mobile Number" name="txtMobilenumber" id="txtMobilenumber" required="required">
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
												<label>Email Id <span class="mandatory">*</span></label> <input type="email" value="<?php echo $resultVisitor[0]->vis_email;  ?>" class="form-control"
													...
													<div class="tab-content">
														...
														<div id="tab2" class="tab-pane fade">
															<div class="row">
																<div class="col-md-8">
																	<div class="form-group">
																		<label class="control-label col-md-5">Select Contact Group <?php //echo "<pre>"; print_r($resultGroup); print_r($resultVisitorgroup); ?><span class="required"> * </span>
																		</label>
																		<div class="col-md-6">
														...
														<div id="tab3" class="tab-pane fade">
															<div class="profile-userbuttons col-md-6">
																<label>Upload Profile Pic</label> <input type="file" class="form-control col-md-3" name="txtFile"> <input type="hidden" class="form-control col-md-3"
																		   ...
																		   if($type!="textarea")
																			{
																				if ($type != "select")
																				{
																					...
																					$vsdata=$this->visitor_model->getcustomfieldvalue($resultCustom[$i]->cfi_id_pk,$VisitorId);
																					$fieldval="";
																					
																					if(count($vsdata)>0)
																					{
																						$fieldval=$vsdata[0]->vcf_value;
																					}	
																					
																					
																				?>												     
																				  <input type="<?php echo $type;?>" name="custom_<?php echo $i;?>[]" class="form-control" value="<?php echo $fieldval;?>">											        
																				  <?php	
																				 }	
																				 else 												 	
																				 {  
																			...
																			?>											     
																			  <textarea name="custom_<?php echo $i;?>[]" class="form-control"><?php echo $fieldval;?></textarea>											    
																			  <?php 											
																			 }	?>											
