							...
							<form role="form" id="frmAdd" method="post" action="<?php echo base_url()?>admin/visitor/addVisitor" enctype="multipart/form-data">
								<div class="form-body" style="padding-top: 10px;">
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
												<label>Select Title<span class="mandatory">*</span></label> <select class="form-control" name="selTitle" id="selTitle" required="required">
										...
										<div class="col-md-3">
											<div class="form-group">
												<div class="form-group">
													<label>First name <span class="mandatory">*</span></label> <input type="text" class="form-control" placeholder="First name" name="txtFirstname" id="txtFirstname"
													 required="required">
												</div>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
												<div class="form-group">
													<label>Middle Name <span class="mandatory">*</span></label> <input type="text" class="form-control" placeholder="Middle Name" name="txtMiddlename" id="txtMiddlename"
													 required="required">
												</div>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
												<div class="form-group">
													<label>Last Name <span class="mandatory">*</span></label> <input type="text" class="form-control" placeholder="Last Name" name="txtLastname" id="txtLastname"
													 required="required">
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
												<label>Mobile Number <span class="mandatory">*</span></label> <input type="number" step="any" min="10" class="form-control" placeholder="Mobile Number"
												 name="txtMobilenumber" id="txtMobilenumber" required="required">
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
												<label>Email Id <span class="mandatory">*</span></label> <input type="email" class="form-control" placeholder="Email Id" name="txtEmail" id="txtEmail"
												 required="required">
											</div>
										</div>
									</div>
													...
													<div class="tab-content">
														<div id="tab1" class="tab-pane fade in active">
															<div class="row">
																<div class="col-md-6" style="border-right: solid 1px #eaeaea;">
																	<div class="form-group">
																		<label class="control-label col-md-4">Enter Address <span class="required"> * </span>
																		</label>
																		<div class="col-md-8">
																	...
																	<div class="form-group">
																		<label class="control-label col-md-4">Enter State <span class="required"> * </span>
																		</label>
																		<div class="col-md-8">
														...
														<div id="tab2" class="tab-pane fade">
															<div class="row">
																<div class="col-md-8">
																	...
																	<div class="form-group">
																		<label class="control-label col-md-5">DOB<span class="required"> * </span>
																		</label>
																		<div class="col-md-6">
																	...
																	<!--  name="rpassword" -->
																	<div class="form-group">
																		<label class="control-label col-md-5">Anniversary Date<span class="required"> * </span>
																		</label>
																		<div class="col-md-6">
																			<div class="input-group input-medium date date-picker" data-date-end-date="+0d" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
														...
														<div id="tab3" class="tab-pane fade">
															<div class="profile-userbuttons col-md-6">
																<label>Upload Profile Pic</label> <input type="file" class="form-control col-md-3" name="txtFile">
												                ...
												                <?php for($i=0;$i < count($resultField);$i ++)
																	...
																	?>
																	 ...
																	 <?php /*?> <span class="input-group-addon bgnone">
																	  ...
																	  <label><?php echo $resultField[$i]->visitfield_name;?></label>
												                ...
												                <?php for($i=0;$i < count($resultCustom);$i ++)
																	...
																	?>
																	 ...
																	 <?php /*?> <span class="input-group-addon bgnone">
																	  ...
																	  <label><?php echo $resultCustom[$i]->cfi_label;?></label>
																		   ...
																		   if($type!="textarea")
																			{
																				...
																				{
																				?>												     
																				  <input type="<?php echo $type;?>" name="custom_<?php echo $i;?>[]" class="form-control">											        
																				  <?php	
																				 }	
																				 else 												 	
													...
													<div class="row">
														<div class="col-md-12">
															<div class=" pull-right">
																...
																<a type="button" href="<?php echo base_url()?>admin/visitor" class="btn btn-danger">Cancel</a>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="form-body">
														<div class="row" id="frmAddgroup">
															<div class="col-md-10 pull-left">
																<label>Group Name <small>(char limit-20)</small></label> <input type="text" name="txtGroupname" id="txtGroupname" class="form-control" placeholder="Group Name"
																 maxlength="20">
															</div>
