                                        ...
                                        <div class="row">
                                            <div class="" style="display:none;" id="advance_form">
                                                ...
                                                <div class="form-group col-md-2"> 
                                                    <select name="example-list" class=" form-control">
                                    ...
                                    <div class="row" style="">
                                        ...
                                        <div class="col-md-11">
                                            <div class="form-group">
                                                ...
                                                <select name="email_templates" id="email_templates" class="form-control">
                                                    <option value="">Select Email Template</option>
                                                    <?php
                                                    for($i=0;$i<count($resultTemplateReq);$i++)
                                                    {
                                                    ?>
                                                    <option value="<?php echo $resultTemplateReq[$i]->etr_id_pk;?>"><?php echo $resultTemplateReq[$i]->etr_template_name;?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
