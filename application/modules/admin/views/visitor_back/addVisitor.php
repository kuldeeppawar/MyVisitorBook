            ...
            <div class="col-md-12 col-sm-12">
                <div class=" app-ticket-list">
                    <div class="page-bar row">
                        <div class="col-md-6">
                            <h3 class="page-title">Add New Visitor</h3>
                            <ul class="page-breadcrumb ">
                                <li><a href="<?php echo base_url()?>admin/dashboard">Home</a> <i class="fa fa-circle"></i></li>
                                <li><a href="<?php echo base_url()?>admin/visitor">Visitor Management</a> <i class="fa fa-circle"></i></li>
                                <li><span>Add New Visitor</span></li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <div id="reportrange" class="btn pull-right " style="padding-top: 12px;">
                                <i class="fa fa-calendar"></i> &nbsp; <span class="thin uppercase hidden-xs">August 28, 2016 - September 26, 2016</span>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="selTitle" id="selTitle" required="required">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="First name" name="txtFirstname" id="txtFirstname" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Middle Name" name="txtMiddlename" id="txtMiddlename" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Last Name" name="txtLastname" id="txtLastname" required="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Mobile Number <span class="mandatory">*</span></label>
                                                    <input type="number" step="any" min="10" class="form-control" placeholder="Mobile Number" name="txtMobilenumber" id="txtMobilenumber" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Email Id <span class="mandatory">*</span></label>
                                                <input type="email" class="form-control" placeholder="Email Id" name="txtEmail" id="txtEmail" required="required">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a data-toggle="tab" href="#tab1">Contact Details</a></li>
                                                    <li><a data-toggle="tab" href="#tab2">Personal Info</a></li>
                                                    <li><a data-toggle="tab" href="#tab4">Notes</a></li>
                                                    <li><a data-toggle="tab" href="#tab5">Additional Info</a></li>
                                                    <li><a data-toggle="tab" href="#tab3">Profile Pic</a></li>
                                                </ul>
                                                <!-- Modal -->
                                                <!-- ends -->
                                                        ...
                                                        <div id="tab1" class="tab-pane fade in active">
                                                            <div class="row">
                                                                <div class="col-md-6" style="border-right: solid 1px #eaeaea;">
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-4">Enter Address <span class="required"> * </span></label>
                                                                        <div class="col-md-8">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-4">Enter Country <span class="required"> * </span>
                                                                        </label>
                                                                        <div class="col-md-8">
							...
							{?>
                                                                                    <option value="<?php echo $resultCountry[$i]->cntr_id_pk;?>" <?php if($resultCountry[$i]->cntr_status==0){ echo "disabled"; } ?> >
							...
							?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-4">Enter State <span class="required"> * </span> </label>
                                                                        <div class="col-md-8">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-4">Enter City <span class="required"> * </span>
                                                                        </label>
                                                                        <div class="col-md-8">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-4">Enter Zip Code <span class="required"> * </span>
                                                                        </label>
                                                                        <div class="col-md-8">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-4">Your Website<span class="required"> * </span>
                                                                        </label>
                                                                        <div class="col-md-8">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-4">Landline Number<span class="required"> * </span>
                                                                        </label>
                                                                        <div class="col-md-8">
                                                        ...
                                                        <div id="tab2" class="tab-pane fade">
                                                            <div class="row">
                                                                <div class="col-md-8">
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-5">Select Contact Group <span class="required"> * </span>
                                                                        </label>
                                                                        <div class="col-md-6">
                                                                            <select id="multiple" name="selGroup[]" class="form-control select2-multiple" data-placeholder="Select Group" multiple required="required">
                                                                                <?php																					
									for($i=0;$i<count($resultGroup);$i++)																					{																					
										?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-5">Select Business Category<span class="required"> * </span>
                                                                        </label>
                                                                        <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-5"> Business Name<span class="required"> * </span>
                                                                        </label>
                                                                        <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-5">DOB<span class="required"> * </span> </label>
                                                                        <div class="col-md-6">
											...
											<button class="btn default" type="button">																						<i class="fa fa-calendar"></i>																					</button>																				
                                                                    ...
                                                                    <!--  name="rpassword" -->
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-5">Anniversary Date<span class="required"> * </span> </label>
                                                                        <div class="col-md-6">
                                                                            <div class="input-group input-medium date date-picker" data-date-end-date="+0d" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
										...
										<button class="btn default" type="button">																						<i class="fa fa-calendar"></i>																					</button>																				
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <div class="btn-group" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">
                                                                            <button id="sample_editable_1_new" type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal1"> <i class="fa fa-plus"></i> Create Contact group </button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div id="tab3" class="tab-pane fade">
                                                            <div class="profile-userbuttons col-md-6">
                                                                ...
                                                                <input type="file" class="form-control col-md-3" name="txtFile">
                                                                <!-- 																<button type="button" class="btn btn-circle green btn-sm">Upload</button> -->
                                                                <br>
                                                                <br> </div>
                                                        </div>
                                                        <div id="tab4" class="tab-pane fade">
                                                            <h3 class="block">Provide your Other Details</h3>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>Enter Info</label>
                                                                    <textarea class="form-control" rows="3" placeholder="Type Here" name="txtInfo"> </textarea>
                                                                </div>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class=" pull-right">
                                                                <button type="submit" name="btnSubmit" class="btn btn-primary">Save</button> <a type="button" href="<?php echo base_url()?>admin/visitor" class="btn btn-danger">Cancel</a> </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h2 class="modal-title text-center">															<i class="fa fa-user-plus"></i> Create Contact Group															
                                                </h3>
</div>
        ...
        <div class="form-body">
            <div class="row" id="frmAddgroup">
                <div class="col-md-10 pull-left">
                    ...
                    <input type="text" name="txtGroupname" id="txtGroupname" class="form-control" placeholder="Group Name" maxlength="20"> </div>
                <div class="col-md-2 pull-right">
                    <button type="submit" onclick="submitgroupDetails();" class="btn btn-primary" style="margin-top: 24px;">Save</button>
                </div>
            </div>
            <?php /*?>
                <div class="col-md-12">
                    <div class="row">
                        <div class="input-group col-md-6">
                            <div class="mt-checkbox-list">
                                <label class="mt-checkbox mt-checkbox-outline" id="advance" style="line-height: 16px; margin-bottom: 0px;">
                                    <input type="checkbox" name="colorCheckbox" value="green"> Advance your search <span></span> </label>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-7 pull-left">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control input-sm" placeholder="Business Name"> </div>
                                </div>
                                <div class="col-md-5 pull-right">
                                    <button type="button" class="btn btn-danger" style="margin-top: 20px;"> <i class="fa fa-cloud-download"></i> Download sample csv </button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer" style="float: right;">
                    <button type="button" class="btn btn-primary"> <i class="fa fa-level-down"></i> Import Contacts </button> <a href="visitor_manage.html" class="btn btn-danger">Cancel</a> </div>
                <?php */?>
        </div>
        <div class="row"></div>
    </div>
...
<script src="<?php echo base_url(); ?>themes/assets/global/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="<?php echo base_url(); ?>themes/assets/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<?php echo base_url(); ?>themes/assets/pages/scripts/form-wizard.min.js" type="text/javascript"></script>
...
<!-- download csv file option starts here -->
...
<script type="text/javascript">
    $(function() {
                $(".select1").multiselect({ //selectedList: 4    });        $(".select1").multiselect({   selectedText: function(numChecked, numTotal, checkedItems){      return numChecked + ' of ' + numTotal + ' checked';   }}); $('#advance').click(function(){    $("#advance_form").show();    $("#select_group").hide();  }); $('#search_select1').click(function(){    $("#select_group").show();    $("#advance_form").hide();  });    });
</script>
<!-- ends here -->
