			...
			<div class="col-md-12">
				<div class=" app-ticket-list">
					<div class="page-bar row">
						<div class="col-md-6">
							<h3 class="page-title">Visitor Managmement</h3>
									...
									<div class="col-md-5  pull-right">
										<div class="pull-right">
											<div style="float: left; margin-top: 8px; margin-right: 5px;">
												<a href="#" onclick="getDetails()" id="sb3" class="margin_rgt" style="display: inline;">
											...
											<?php
											if(getAdminAccessRights('mvbSetVfIE'))
											{
											?>
											<a href="#" data-toggle="modal" data-target="#otpimport" class="p_element11"> Import </a> 
											<span class="p_element11">/</span>
											 <a href="#" class="p_element11" data-toggle="modal" data-target="#otp"> Export </a>
											<?php } ?>
											<div class="btn-group">
											<?php
											if(getAdminAccessRights('mvbSetVfAdd'))
											{
												?>
											...
											<ul class="nav navbar-nav pl0 pull-right" style="margin-left: 5px;">
												<li class="dropdown dropdown-user burger_menu"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" style="margin-top: 0px;"><i class="fa fa-bars fa-2x" aria-hidden="true"></i>
													...
													<ul class="dropdown-menu dropdown-menu-default">
												<?php
												if(getAdminAccessRights('mvbSetVfpal'))
												{
												?>
											    ...
											    <?php } ?>
											    <?php
												if(getAdminAccessRights('mvbSetVfccg'))
												{
												?>
														<li class="options" style="border-bottom: 1px solid #e7ecf1;"><a href="#" title="Custom Fields" style="padding: 5px; margin-top: 5px;">Change Contact Group</a></li>
											    <?php } ?>
											    <?php
												if(getAdminAccessRights('mvbSetVfmgf'))
												{
												?>
														<li class="options" style="border-bottom: 1px solid #e7ecf1;"><a href="custom_fields.html" title="Custom Fields" style="padding: 5px; margin-top: 5px;">Manage custom Fields</a></li>
												<?php } ?>
																		...
																		<div class="row">
																			<div class="col-md-12">
																				<div class="modal-footer">
																					<a href class="btn btn-primary" onclick="deleteVisitor();">Yes</a>
																		...
																		<div class="form-body">
																			<div class="row">
																				<div class="col-md-12">
																					...
																					<a onclick="getSamplecsv()" href="#">Download Sample CSV</a>
																					<div class="modal-footer">
...
function getDetails()
{
     ...
     for (var i=1;i<=count;i++)
     {
   	  ...
   	  {
   		visitor=$("#chk"+i).val(); 
   		window.location.href = '<?php echo base_url()?>admin/visitor/editVisitor/'+visitor;
   	  }
     } 
}
