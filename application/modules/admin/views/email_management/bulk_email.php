            ...
            <div class="col-md-12">
                <div class=" app-ticket-list">
                    <div class="page-bar row">
                        <div class="col-md-6">
                            <h3 class="page-title"><?php getLocalkeyword('Send Bulk Email');?></h3>
                            <ul class="page-breadcrumb ">
                                <li> <a href="<?php echo base_url(); ?>admin/dashboard"><?php getLocalkeyword('Home');?></a> <i class="fa fa-circle"></i> </li>
                                <li> <a href="<?php echo base_url(); ?>admin/email_management"><?php getLocalkeyword('Email Management');?></a> <i class="fa fa-circle"></i> </li>
                                <li> <span><?php getLocalkeyword('Send Bulk Email');?></span> </li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <form role="form" onsubmit="return checkForm();" action="<?php echo base_url(); ?>admin/email_management/addCampaign" id="CampaignForm" method="POST">
                                <div class="form-body">
                                    <div class="col-md-12 pl0" style="padding-top: 5px;">
                                        <div class="input-group col-md-3">
                                            <div class="mt-checkbox-list">
                                                <label>
                                                    <input name="search_by_name_email" class="check_box" type="checkbox" <?php if($way=="user"){ echo "checked";}?> id="chk_email" value="1">
                                        ...
                                        <div class="input-group col-md-3">
                                            <div class="mt-checkbox-list">
                                                <label>
                                                    <input <?php if($way=="group"){ echo "checked";}?> name="select_group" class="check_box" type="checkbox"  id="chk_group" value="1">
                                        ...
                                        <div class="input-group col-md-3">
                                            <div class="mt-checkbox-list">
                                                <label>
                                                    <input name="advance_search" class="check_box" type="checkbox"  id="adv_search" value="1">
                        ...
                        <input type="hidden" name="advanceSearchUserId" id="advanceSearchUserId">
                                    ...
                                    <div class="row" style="">
                                        ...
                                        <div class="col-md-6 form-group">               
                                                <label><?php getLocalkeyword('Subject Name');?></label>
                                                <input name="subject_name" type="text" id="subject_name" class="form-control" placeholder="Enter Subject Name">
                                            
                                                <div class="col-md-12 pl0"><div id="subject_error" style="color:red; font-size:11px;" class="input-group col-md-12"></div></div>
                                        </div>

                                        <div class="clearfix"></div>
                                        <div class="col-md-11">
                                            <div class="form-group">
                                                <label><?php getLocalkeyword('Select Email content from existing template');?></label>
                                                <select name="email_templates" id="email_templates" class="form-control smstemplate">
                                                    <option value="">Select Email Template</option>
                                                    <?php
                                                    for($i=0;$i<count($resultTemplateReq);$i++)
                                                    {
                                                    ?>
                                                    <option value="<?php echo $resultTemplateReq[$i]->etr_id_pk;?>"  data-message="<?php echo $resultTemplateReq[$i]->etr_description; ?>" ><?php echo $resultTemplateReq[$i]->etr_template_name;?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="input-group col-md-1">
                                            <div class="form-group" style="text-align:center;"> <b><?php getLocalkeyword('OR');?></b> </div>
                                        </div>
                                        <div class="clearfix"></div>
                                                    ...
                                                    <label>
                                                       ...
                                                       <?php getLocalkeyword('Schedule');?>  <span></span> </label>
                                                        <div class="input-group date form_datetime" id="schedule1" data-date="2012-12-21T15:25:00Z" style=" display:none;">
                                                            <input name="schedule_date_time" type="text" size="16" readonly class="form-control">
                                                            <span class="input-group-btn">
 ...
 $("#adv_search").click(function () {
    ...
    function checkForm()
    {
        ...
        else
        {
         ...
         //console.log(email_flag+'~'+campaing_flag+'~'+flag);
    ...
    {
          var selectFirstColumn=$(".searchField1").val();
          if(selectFirstColumn.length>0)
          {    
               return true;
          }
          else
          {
               $("#search_error").html("Please select column name.");
               return false;
          }      
    }
