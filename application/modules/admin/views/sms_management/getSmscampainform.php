<div id="otp1" class="modal fade in" role="dialog">
      <div class="modal-dialog">                                
          <div class="modal-content" style="height: 150px;">
                            ...
                            <form id="otp_verify_form" name="otp_verify_form" method="POST" action="<?php echo base_url();?>head/sms_management/verifyExport">
...
<div class="page-content-wrapper"> 
      <div class="page-content" style="min-height:469px">
          ...
          <div class="col-md-12"> 
             <div class=" app-ticket-list">
              <div class="page-bar row">
                <div class="col-md-6">
                  <h3 class="page-title"><?php getLocalkeyword('SMS Management');?></h3>
                  <ul class="page-breadcrumb ">
                    <li> <a href="<?php echo base_url()?>admin/dashboard"><?php getLocalkeyword('Home');?></a> <i class="fa fa-circle"></i> </li>
                    <li> <span><?php getLocalkeyword('SMS Management');?></span> </li>
                  </ul>
                </div>
                <div class="col-md-6">
                </div>
            ...
            <?php 
            if(getAdminAccessRights('mvbSmsExport'))
              { 
            ?>
                <a class="margin_rgt" data-toggle="modal" data-target="#otp1" onclick="getOTP();"><?php getLocalkeyword('Export');?></a> 
            <?php 
              } 
            ?>
					<!-- data-target="#otp11111" <a href="#" data-target="#send_sms1" data-toggle="modal" class="margin_rgt"><img src="../assets/sms.png" height="22" title="Send SMS" /></a>
						...
						<a href="#" data-toggle="modal" data-target="#myModal_m" class="margin_rgt"> <i class="fa fa-trash fa-2x" title="Delete" style="color:#828282; " ></i></a></div>
                          ...
                          <div class="btn-group"> <a href="<?php echo base_url(); ?>admin/sms_management/bulk_sms" id="sample_editable_1_new hvr-float-shadow" class="btn btn-primary pull-right" style="margin-right:0px;">Send SMS</a> </div>
                          <?php } ?>
                          ...
                          <div id="myModal_m" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <button type="button" class="close" data-dismiss="modal">×</button>
                                  <h2 class="modal-title text-center"> <i class="fa fa-trash"></i><?php getLocalkeyword('Are you sure to Delete');?>? </h2>
                                </div>
                                <div class="modal-footer"> <a href="" class="btn btn-primary"><?php getLocalkeyword('Yes');?></a>
		...
		<div class="clearfix"></div>
         <div class="col-md-12">
		 <div class="selected_rows">1/17 row(s) selected <a id="selectall"><?php getLocalkeyword('select all');?></a></div>
             ...
             <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable allchekbox" id="sample_1_2" role="grid" aria-describedby="sample_1_2_info">
              <thead>
                ...
                <span></span> </label>
                            ...
                            <th  style="width: 288px;"><?php getLocalkeyword('Sent On');?>/<?php getLocalkeyword('Scheduling Date');?></th>
                              <th  style="width: 230px;"><?php getLocalkeyword('Message Details');?></th>
                              <th  style="width: 176px;"><?php getLocalkeyword('Contact Group');?></th>
                              <th  style="width: 137px;"><?php getLocalkeyword('SMS Count');?></th></tr>
              </thead>
              <tbody>
              <tr class="odd gradeX">
              <?php 
                          ...
                          ?>
                            ...
                            <td><?php echo $CampaignRecord['campaignSmsCount']; ?></td>
                            </tr>
                          <?php } ?>  
                          </tbody>
            </table></div>
...
function getOTP()
{
        $.post("<?php echo base_url();?>head/sms_management/getOTP",{},function(data)
        {                                        
                $("#show_send_msg").html('OTP has been send successfully');
        });
}
...
rules:{             
    txtotp:{
        ...
        remote:
        {
                url:"<?php echo base_url();?>head/sms_management/verifyOTP",
                type:"POST",
                data:
                {
                      txtotp:function()
