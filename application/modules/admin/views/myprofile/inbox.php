          ...
          <div class="col-md-12">
            <div class=" app-ticket-list">
			  ...
			  <!--end modal-->
                ...
                <div class="col-md-12"> <div class="table-toolbar">
                    ...
                    <div class="portlet light">
                      ...
                      <div class="portlet-body">
                        ...
                        <table class="table table-hover table-checkable order-column" id="sample_1" style="width:100% !important;"  >
                          ...
                          <tbody>
                                <?php 
                                for($i=0;$i<count($inboxDetailes);$i++)
                                {
                                ?>
                            <tr class="odd gradeX">
                              ...
                              <td> <?php echo $i+1; ?> </td>
                              <td><?php echo $inboxDetailes[$i]->csms_title; ?></td>

                              <td><?php echo $inboxDetailes[$i]->csms_content; ?></td>

                             
                              <td><?php echo $inboxDetailes[$i]->csms_sendDate; ?></td>
