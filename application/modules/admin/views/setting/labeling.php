...
<div class="page-content-wrapper">
			...
			<div class="col-md-12">
				<div class=" app-ticket-list">
					<div class="page-bar row">
						<div class="col-md-6">
							<h3 class="page-title"><?php getLocalkeyword('Address Labeling');?> </h3>
							<ul class="page-breadcrumb ">
								<li><a href="<?php echo base_url()?>admin/dashboard"><?php getLocalkeyword('Home');?> </a> <i class="fa fa-circle"></i></li>
								<li><a><?php getLocalkeyword('Setting');?> </a> <i class="fa fa-circle"></i></li>
								<li><span><?php getLocalkeyword('Address Labeling');?></span></li>
							</ul>
						</div>
					 ...
					 ?>
						<!-- <form>
							<div class="col-md-2">
								<div class="form-group">
									<label><?php getLocalkeyword('Font');?> </label> 
									<select class="form-control" name="selFont" id="selFont">
										<option value="Arial" <?php if($result[0]->labeling_font=="Arial"){ echo "selected"; }?> >Arial</option>
										<option value="OpenSans" <?php if($result[0]->labeling_font=="OpenSans"){ echo "selected"; }?>>OpenSans</option>
									</select>
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
									<label><?php getLocalkeyword('Font Size');?></label> <select class="form-control" name="selFontsize" id="selFontsize">
										<option value="10" <?php if($result[0]->labeling_size=="10"){ echo "selected"; }?>>10</option>
										<option value="11" <?php if($result[0]->labeling_size=="11"){ echo "selected"; }?>>11</option>
										<option value="12" <?php if($result[0]->labeling_size=="12"){ echo "selected"; }?>>12</option>
									</select>
								</div>
							</div>
							...
							<div class="col-md-2">
								...
								$data=explode(",",$result[0]->labeling_style);
								   
								   
								?>
									<label>Font Style</label> <br> 
									<label class="checkbox-inline"> 
									         <input type="checkbox" value="1" name="chkStyle[]" id="chkStyle1"  <?php if($data[0]=="1"){ echo "checked"; }?>>B
									</label> 
									<label class="checkbox-inline"> 
									<input type="checkbox" value="2" name="chkStyle[]"   id="chkStyle2" <?php if($data[1]=="1"){ echo "checked"; }?>>I
									</label> 
									<label class="checkbox-inline"> 
									<input type="checkbox" value="3" name="chkStyle[]"  id="chkStyle3" <?php if($data[2]=="1"){ echo "checked"; }?>>U
									</label>
								</div>
							</div>
							...
							<div class="col-md-2">
								<div class="form-group">
									<label><?php getLocalkeyword('Choose Font Color');?></label> <br> 
									<input type="text" placeholder="Choose Color"  id="txtColor" value="<?php echo  $result[0]->labeling_color?>"
									name="txtColor" class="jscolor" style="padding: 5px; width: 100%;">
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
									<label><?php getLocalkeyword('Text Align');?></label> <br> <label class="radio-inline" style="padding-left: 15px;"> 
									<input type="radio" value="1" name="rdbAlignment"  id="rdbAlignment1" <?php if( $result[0]->labeling_allign=="1"){ echo "selected"; }?>>Left
									</label> <label class="radio-inline" style="padding-left: 15px;"> 
									<input type="radio" value="2" name="rdbAlignment"   id="rdbAlignment2" <?php if( $result[0]->labeling_allign=="2"){ echo "selected"; }?>>Center
									</label> <label class="radio-inline" style="padding-left: 15px;"> 
									<input type="radio" value="3" name="rdbAlignment"  id="rdbAlignment3"  <?php if( $result[0]->labeling_allign=="3"){ echo "selected"; }?>>Right
									</label>
								</div>
							</div>
							...
							<div class="col-md-2">
								<div class="form-group">
									<label><?php getLocalkeyword('Select Label Size');?></label> <br> 
									<select class="form-control" name="selLabelsize" id="selLabelsize">
										<option value="10" <?php if( $result[0]->labeling_labelsize=="10"){ echo "selected"; }?>>10</option>
										<option value="11" <?php if( $result[0]->labeling_labelsize=="11"){ echo "selected"; }?>>11</option>
									</select>
									<input type="hidden" id="txtId" value="<?php echo  $result[0]->labeling_id_pk;?>">
								</div> 
							</div>
						</form> -->
						<?php 
					  ...
					  {	
					   ?>
					   		...
					   		<form action="<?php echo base_url()?>admin/setting/labelingAction" method="POST" id="labeling_form" name="labeling_form">
							<div class="col-md-2">
								<div class="form-group">
									<label><?php getLocalkeyword('Font');?></label> 
									<select class="form-control" name="selFont" id="selFont">
										<option value="Arial" checked>Arial</option>
							...
							<div class="col-md-2">
								<div class="form-group">
									<label><?php getLocalkeyword('Font Style');?></label> <br> 
									<label class="checkbox-inline"> 
									         <input type="checkbox" value="b" name="chkStyle_b" id="chkStyle1" checked>B
									</label> 
									<label class="checkbox-inline"> 
									<input type="checkbox" value="i" name="chkStyle_i" id="chkStyle2">I
									</label> 
									<label class="checkbox-inline"> 
									<input type="checkbox" value="u" name="chkStyle_u" id="chkStyle3">U
									</label>
								</div>
							</div>
							<div class="clearfix"></div>
							<div class="col-md-2">
								<div class="form-group">
									<label><?php getLocalkeyword('Choose Font Color');?></label> <br> 
									<input type="text" placeholder="Choose Color" name="txtColor" id="txtColor" class="jscolor" style="padding: 5px; width: 100%;" value="000000">
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
									<label><?php getLocalkeyword('Text Align');?></label> <br> <label class="radio-inline" style="padding-left: 15px;"> 
									<input type="radio" value="left" name="rdbAlignment" id="rdbAlignment1" checked>Left
									</label> <label class="radio-inline" style="padding-left: 15px;"> 
									<input type="radio" value="center" name="rdbAlignment" id="rdbAlignment2">Center
									</label> <label class="radio-inline" style="padding-left: 15px;"> 
									<input type="radio" value="right" name="rdbAlignment" id="rdbAlignment3">Right
									</label>
								</div>
							</div>
							<div class="col-md-2">
								...
								<input type="hidden" id="hidden_visitors_id" name="hidden_visitors_id" value="<?php echo $result;?>">
							</div>
							<div class="col-md-12">
								<button type="submit" class="btn btn-primary" name="print_preview"><?php getLocalkeyword('Print Preview');?></button> 
									<?php 
									if(getAdminAccessRights('mvbaddresslabelingSave'))
									{
									?>	
										<button type="button" class="btn btn-primary" target="_blank" name="generate_print" onclick="submitValue();"><?php getLocalkeyword('Save');?></button>
									  <?php 
									}
									?>
							</div>
   ...
   <script type="text/javascript">
    ...
    {
       // var labelsize=$("#selLabelsize").val();
      
       // var txtId=$("#txtId").val();
       // var txtColor=$("#txtColor").val();
     
       // var selFontsize=$("#selFontsize").val();
       // var selFont=$("#selFont").val();
    	
       // if($("#chkStyle1").is(':checked'))
       // {
    	  //  chkStyle1=$("#chkStyle1").val();
       //     }
       // else
       // {
    	  //  chkStyle1="0";
       //     }
       // if($("#chkStyle2").is(':checked'))
       // {
    	  //  chkStyle2=$("#chkStyle2").val();
       //     }
       // else
       // {
    	  //  chkStyle2="0";
       //     }
       // if($("#chkStyle3").is(':checked'))
       // {
    	  //  chkStyle3=$("#chkStyle3").val();
       //     }
       // else
       // {
    	  //  chkStyle3="0";
       ...
       // var style=chkStyle1+","+chkStyle2+","+chkStyle3;
       // var rdbButton="0";
       // if($("#rdbAlignment1").is(':selected'))
       // {
    	  //  rdbButton=$("#rdbAlignment1").val();
       //  }
       
       // if($("#rdbAlignment2").is(':selected'))
       // {
    	  //  rdbButton=$("#rdbAlignment2").val();
       //  }
       
       // if($("#rdbAlignment3").is(':selected'))
       // {
    	  //  rdbButton=$("#rdbAlignment3").val();
       // }

		 $.post("<?php echo base_url();?>admin/setting/labelingAction",
			 $('#labeling_form').serialize(),function(data){
              //location.reload();

              	//console.log(data);

              	   var printWindow = window.open('', '', 'height=650,width=1350');
