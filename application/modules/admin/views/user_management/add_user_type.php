									...
									<div id="test-list">
										<ul class="list list-group All_list">
                                                    ...
                                                    <?php
																																																				...
																																																				{
																																																					?>                                                        
                                                                <li class="list-group-item"><input type="checkbox" height="20" width="20" class="check_box1" id="chkUserTypeId_<?php echo $ut;?>"
												name="chkUserTypeId" value="<?php echo $resultUsertype[$ut]->utyp_id_pk;?>" onclick="uncheck_checkbox_edit('<?php echo $resultUsertype[$ut]->utyp_id_pk;?>','<?php echo $ut;?>');"
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label><?php getLocalkeyword('User Type Name');?> </label> <input type="text" class="form-control" placeholder="Enter User Type Name" id="txtUserTypeName" name="txtUserTypeName" required>
											</div>
										</div>
									</div>
									<div class="row">
                        ...
                        <div class="col-lg-6" style="margin-left: -72px;">
										<div class="checkbox" class="form-control">
											<label for="cname" class="control-label col-lg-3"></label> <input type="checkbox" class="main_module"
												...
												value="<?php echo $module[$i]->mod_id_pk?>"
