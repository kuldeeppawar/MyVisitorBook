                ...
                <div class="page-content">
                                ...
                                <div class="page-bar row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <ul class="page-breadcrumb ">
                                            ...
                                            <li><span>Add New User Type</span></li>
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <a onclick="deleteUserType();" class="btn btn-primary">Yes</a>
                                    ...
                                    ?> 
                                                <div class="col-md-6 col-sm-12  pull-right">
                                                    ...
                                                    <div class="" style=" float:right; margin-bottom: 4px; margin-top:12px;">
                                                        ...
                                                        <a data-toggle="modal"  class="margin_rgt" id="sb3" style="display: inline;"> <i class="fa fa-trash fa-2x " title="Delete" onclick="checkUserType();" style="color:#828282; "></i></a>
                                                ...
                                                <div id="test-list">
                                                    ...
                                                    ?>                                                        
                                                                <li class="list-group-item">
                                                                    ...
                                                                    <input type="checkbox" height="20" width="20" class="check_box1" id="chkUserTypeId_<?php echo $ut;?>" name="chkUserTypeId" value="<?php echo $resultUsertype[$ut]->utyp_id_pk;?>" onclick="uncheck_checkbox_edit('<?php echo $resultUsertype[$ut]->utyp_id_pk;?>','<?php echo $ut;?>');"> <?php echo $resultUsertype[$ut]->utyp_userType;?> 
                    ...
                    <li> <a href="javascript:;"> <i class="fa fa-angle-right"></i> </a> </li> -->
                                    ...
                                    <div id="user_type_privileges_div">
                                           ...
                                           <form id="frmUserType" name="frmUserType" method="POST" action="<?php echo base_url();?>admin/user_management/addUserType" >
                        ...
                        <div class="col-lg-6" style="margin-left:-72px;">
                                <div class="checkbox" class="form-control">
                                    ...
                                    <input type="checkbox" class="main_module" onclick="checked_all(this,'<?php echo $module[$i]->mod_module_name?>_module',<?php echo $module[$i]->mod_id_pk;?>);" id="<?php echo $module[$i]->mod_module_name?>" name="modules[]" value="<?php echo $module[$i]->mod_id_pk?>">&nbsp; <font style="font-weight:bold;"><?php echo $module[$i]->mod_module_name?></font>
                                </div>
                                <div class="submodule_checkbox" class="form-control"  id="<?php echo $module[$i]->mod_module_name?>_module" style="margin-left:160px;display:none;">
                                    <?php
                                    $sub_modulename=$this->user_management_model->getallsubmodule($module[$i]->mod_id_pk);
                                     for($j=0;$j<count($sub_modulename);$j++)
                                     {                  
                                    ?>
                                            <input type="checkbox" id="all_modules_<?php echo $module[$i]->mod_id_pk;?>_<?php echo $count_sub;?>" class="module_<?php echo $sub_modulename[$j]->mod_menu_id?>" value="<?php echo $sub_modulename[$j]->mod_id_pk;?>" name="modules[]"  onclick="checked_all_sub(this,<?php echo $module[$i]->mod_id_pk;?>,<?php echo $j+1;?>),checkSubmoduleCheck(<?php echo $sub_modulename[$j]->mod_menu_id?>,'<?php echo $module[$i]->mod_module_name?>');">&nbsp; <font style="font-weight:bold;"><?php echo $sub_modulename[$j]->mod_module_name;?></font><br>
