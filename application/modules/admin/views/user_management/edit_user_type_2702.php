                ...
                <div class=" app-ticket-list">
                    ...
                    <div class="page-bar row">
                        ...
                        <div class="col-md-6">
                            ...
                            <h3 class="page-title">Add New User Type</h3>

                            <ul class="page-breadcrumb ">

                                <li> <a href="index.html">Home</a> <i class="fa fa-circle"></i> </li>

                                <li> <a href="#">System User Management</a> <i class="fa fa-circle"></i> </li>

                                <li> <a>User Type Management</a><i class="fa fa-circle"></i> </li>

                                <li><span>Add New User Type</span>
                                </li>
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="modal-footer"> <a onclick="deleteUserType();" class="btn btn-primary">Yes</a>
                        ...
                        ?>
                                    <div class="col-md-6 col-sm-12  pull-right">
                                        ...
                                        <div class="" style=" float:right; margin-bottom: 4px; margin-top:12px;">
                                            ...
                                            <a href="#" data-toggle="modal" class="margin_rgt" id="sb3" style="display: inline;"> <i class="fa fa-trash fa-2x " title="Delete" style="color:#828282;" onclick="checkUserType();"></i>
                                            </a>
                                ...
                                <div class="portlet-body" style="height:470px; overflow: auto;padding:0px;">
                                    ...
                                    <div id="test-list">
                                        ...
                                        <ul class="list list-group All_list">
                                            ...
                                            <?php for($ut=0;$ut<count($resultUsertype);$ut++) { ?>
                                            <li class="list-group-item">

                                                <input type="checkbox" height="20" width="20" class="check_box1" id="chkUserTypeId_<?php echo $ut;?>" name="chkUserTypeId" value="<?php echo $resultUsertype[$ut]->utyp_id_pk;?>" onclick="uncheck_checkbox_edit('<?php echo $resultUsertype[$ut]->utyp_id_pk;?>','<?php echo $ut;?>');" <?php if($info['utyp_id_pk']==$resultUsertype[$ut]->utyp_id_pk){?> checked
                                                <?php }?>>
                                                <?php echo $resultUsertype[$ut]->utyp_userType;?>
                    ...
                    <li> <a href="javascript:;"> <i class="fa fa-angle-right"></i> </a> </li> -->
                        ...
                        <div id="user_type_privileges_div">
                            ...
                            <form id="frmUserType" name="frmUserType" method="POST" action="<?php echo base_url();?>admin/user_management/editUserType">
                                        ...
                                        { 
                                            ...
                                            <div class="col-lg-6" style="margin-left:-72px;">
                                                <div class="checkbox" class="form-control">
                                                    ...
                                                    <input type="checkbox" class="main_module" onclick="checked_all(this,'<?php echo $module[$i]->mod_module_name?>_module',<?php echo $module[$i]->mod_id_pk;?>);" id="<?php echo $module[$i]->mod_module_name?>" id="<?php echo $module[$i]->mod_module_name?>" name="modules[]" value="<?php echo $module[$i]->mod_id_pk?>" <?php if(in_array($module[$i]->mod_id_pk,$user_type_privileges)){?> checked
                                                    <?php } ?>>&nbsp; <font style="font-weight:bold;"><?php echo $module[$i]->mod_module_name?></font>
                                                </div>
                                                <div class="submodule_checkbox" class="form-control" id="<?php echo $module[$i]->mod_module_name?>_module" style="margin-left:160px;">
                                                    <?php $sub_modulename=$this->user_management_model->getallsubmodule($module[$i]->mod_id_pk); 
                                                            for($j=0;$j<count($sub_modulename);$j++) 
                                                        { ?>
                                                        <input type="checkbox" id="all_modules_<?php echo $module[$i]->mod_id_pk;?>_<?php echo $count_sub;?>" class="module_<?php echo $sub_modulename[$j]->mod_menu_id?>" value="<?php echo $sub_modulename[$j]->mod_id_pk;?>" name="modules[]"  onclick="checked_all_sub(this,<?php echo $module[$i]->mod_id_pk;?>,<?php echo $j+1;?>),checkSubmoduleCheck(<?php echo $sub_modulename[$j]->mod_menu_id?>,'<?php echo $module[$i]->mod_module_name?>');" <?php if(in_array($sub_modulename[$j]->mod_id_pk,$user_type_privileges)){?> checked
                                                        <?php } ?>>&nbsp;
                                                        <font style="font-weight:bold;"><?php echo $sub_modulename[$j]->mod_module_name;?></font>
                                                        <br>
                                                        ...
                                                        <div class="sub_submodule_checkbox" class="form-control" id="<?php echo $sub_modulename[$j]->mod_module_name?>_module" style="margin-left:90px;">
                                                            ...
                                                            <?php $sub_sub_modulename=$this->user_management_model->getallsubsubmodule($module[$i]->mod_id_pk,$sub_modulename[$j]->mod_id_pk); 
                                                                        for($k=0;$k<count($sub_sub_modulename);$k++) 
                                                                { ?>
                                                                <input type="checkbox" id="all_sub_modules_<?php echo $module[$i]->mod_id_pk;?>_<?php echo $count_sub;?>" class="sub_module_<?php echo $module[$i]->mod_id_pk;?>_<?php echo $j+1?>" value="<?php echo $sub_sub_modulename[$k]->mod_id_pk;?>" name="modules[]" onclick="checkSubSubmoduleCheck(<?php echo $j+1?>,<?php echo $count_sub;?>,'<?php echo $module[$i]->mod_module_name?>',<?php echo $sub_modulename[$j]->mod_menu_id?>);" 
                                                                <?php 
                                                                if(in_array($sub_sub_modulename[$k]->mod_id_pk,$user_type_privileges))
                                                                    {?> checked
                                                                <?php } ?>>&nbsp;
...
<script>
    ...
    {
        $.post("<?php echo base_url();?>head/user_management/getUserTypePrivileges", {
            user_type_id: value
        }, function(data) {
            //alert(data);                                      
    ...
    function deleteUserType()
        {
                     ...
                     for (var i=0;i<=count;i++)
                     {
                          ...
                          {
                              usertypeid.push($("#chkUserTypeId_"+i).val());                              
                          }
                     } 
                                          
                    $.post("<?php echo base_url();?>admin/user_management/deleteUserType",{user_type_id:usertypeid},function(data){
                            console.log(data);
