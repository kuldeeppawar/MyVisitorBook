			...
			<div class="col-md-12">
				<div class=" app-ticket-list">
					<div class="page-bar row">
						<div class="col-md-6">
							<h3 class="page-title"><?php getLocalkeyword('Edit User Type');?></h3>
							<ul class="page-breadcrumb ">
								...
								<li><a><?php getLocalkeyword('User Type Management');?></a><i class="fa fa-circle"></i></li>
								<li><span><?php getLocalkeyword('Edit User Type');?></span></li>
							</ul>
						</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="modal-footer">
															<a onclick="deleteUserType();" class="btn btn-primary"><?php getLocalkeyword('Yes');?></a>
								...
								<div class="portlet-body" style="height: 470px; overflow: auto; padding: 0px;">
									<div id="test-list">
										<ul class="list list-group All_list">
                                            ...
                                            <li class="list-group-item"><input type="checkbox" height="20" width="20" class="check_box1" id="chkUserTypeId_<?php echo $ut;?>" name="chkUserTypeId"
												value="<?php echo $resultUsertype[$ut]->utyp_id_pk;?>" onclick="uncheck_checkbox_edit('<?php echo $resultUsertype[$ut]->utyp_id_pk;?>','<?php echo $ut;?>');"
												<?php if($info['utyp_id_pk']==$resultUsertype[$ut]->utyp_id_pk){?> checked <?php }?>
											>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label><?php getLocalkeyword('User Type Name');?> </label> <input type="text" class="form-control" placeholder="Enter User Type Name" id="txtUserTypeName" name="txtUserTypeName"
													value="<?php echo $info['utyp_userType'];?>" required
												>
											</div>
										</div>
									</div>
                                    ...
                                    <?php
										...
										<div class="checkbox" class="form-control">
											<label for="cname" class="control-label col-lg-3"></label> <input type="checkbox" class="main_module"
												onclick="checked_all(this,'<?php echo $module[$i]->mod_module_name?>_module',<?php echo $module[$i]->mod_id_pk;?>);" id="<?php echo $module[$i]->mod_module_name?>"
												id="<?php echo $module[$i]->mod_module_name?>" name="modules[]" value="<?php echo $module[$i]->mod_id_pk?>" <?php if(in_array($module[$i]->mod_id_pk,$user_type_privileges)){?> checked
												<?php } ?>
...
$sub_modulename=$this->user_management_model->getallsubmodule($module[$i]->mod_id_pk);
												...
												onclick="checked_all_sub(this,<?php echo $module[$i]->mod_id_pk;?>,<?php echo $j+1;?>),checkSubmoduleCheck(<?php echo $sub_modulename[$j]->mod_menu_id?>,'<?php echo $module[$i]->mod_module_name?>');"
												<?php if(in_array($sub_modulename[$j]->mod_id_pk,$user_type_privileges)){?> checked <?php } ?>
											>&nbsp; <font style="font-weight: bold;"><?php echo $sub_modulename[$j]->mod_module_name;?></font> <br>
...
$count_sub ++;
									...
									<div class="col-md-12">
										<div class="modal-footer">
											...
											<a href="<?php echo base_url(); ?>admin/user_management/manage_user_type" class="btn btn-danger">Cancel</a>
										</div>
									</div>
								</div>
