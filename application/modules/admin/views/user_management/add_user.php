		...
		<div class="row">
			<div class="col-md-12">
				<div class=" app-ticket-list">
					...
					<div class="row">
						<div class="">
							<form id="add_user_form" name="add_user_form" role="form" action="<?php echo base_url()?>admin/user_management/addUser" method="post">
								<div class="form-body mtop10">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label><?php getLocalkeyword('Email Id');?> </label> <input type="text" name="txtEmail" id="txtEmail" required="required" class="form-control" placeholder="Enter Email Id">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label><?php getLocalkeyword('Country');?><span class="mandatory">*</span></label> <select class="form-control" name="selCountry" id="selCountry" required="required" onchange="getState(this.value);">
...
$("#add_user_form").validate({
			    rules:{
			        ...
			        txtEmail:{
			            ...
			            remote:
	                      {
	                              url:"<?php echo base_url();?>admin/user_management/getValidateemail",
	                              type:"POST",
	                              data:
	                              {
	                                    txtEmail:function()
