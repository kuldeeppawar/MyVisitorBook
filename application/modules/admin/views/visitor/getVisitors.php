                                ...
                                <div class="form-body" style="padding-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label><?php getLocalkeyword('Middle Name');?></label> <input type="text" class="form-control" value="<?php echo $resultVisitor[0]->vis_middleName;  ?>"
                                                                                                                  placeholder="Middle Name" name="txtMiddlename" id="txtMiddlename">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label><?php getLocalkeyword('Mobile Number');?> <span class="mandatory">*</span></label> <input type="text" value="<?php echo $resultVisitor[0]->vis_mobile;  ?>" maxlength="10" minlength="10" title="Mobile number should start with 7,8 or 9" class="form-control" pattern="^[0]?[789]\d{9}$" placeholder="Mobile Number" name="txtMobilenumber" id="txtMobilenumber" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label><?php getLocalkeyword('Email Id');?> </label> <input type="email" value="<?php echo $resultVisitor[0]->vis_email;  ?>" class="form-control"
                                                                                                            placeholder="Email Id" name="txtEmail" id="txtEmail">
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="tab-content">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" value="<?php echo $resultVisitor[0]->vis_zipCode;  ?>" min="0" class="form-control" name="txtZip" placeholder="Enter Zip Code" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control" value="<?php echo $resultVisitor[0]->vis_website;  ?>" name="txtWebsite" placeholder="Enter your website URL" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control" value="<?php echo $resultVisitor[0]->vis_landline;  ?>" name="txtLandline" placeholder="Enter your Landline Number"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" min="0" class="form-control" value="<?php echo $resultVisitor[0]->vis_fax;  ?>" name="txtFax" placeholder="Enter your FAX Number">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div id="tab2" class="tab-pane fade">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-4" style="text-align: left;"><?php getLocalkeyword('Select Contact Group');?> <?php //echo "<pre>"; print_r($resultGroup); print_r($resultVisitorgroup); ?>
                                                                        </label>
                                                                        <div class="col-md-7">
                                                                            ...
                                                                            //																			?>
                                                                            <?php
                                                                            //                                                                       print_r($resultVisitorgroup);
                                                                            $sorted = '';
                                                                            for($i=0;$i<count($resultVisitorgroup);$i++)
                                                                            {
                                                                                $sorted .= $resultVisitorgroup[$i]->gv_grpId_fk.',';
                                                                            }
                                                                            $sorted1 = rtrim($sorted,",");


                                                                            $sorted_array = explode(',',$sorted1);
                                                                            //                                                                        print_r($sorted);
                                                                            ?>
                                                                            <select class="selectpicker form-control" name="selGroup[]" multiple="multiple" data-selected-text-format="count > 3">
                                                                                <?php
                                                                                for($i=0;$i<count($resultGroup);$i++)
                                                                                {  ?>
                                                                                    <option
                                                                                        ...
                                                                                        if (in_array($resultGroup[$i]->grp_id_pk, $sorted_array)) {
                                                                                            echo "selected='selected'";
                                                                                        }
                                                                                        ?>

                                                                                            data-tokens="<?php echo $resultGroup[$i]->grp_name; ?>" value="<?php echo $resultGroup[$i]->grp_id_pk; ?>"><?php echo $resultGroup[$i]->grp_name; ?></option>
                                                                                    <?php
                                                                                } ?>
                                                                            </select>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-7">
                                                                            <input type="text" class="form-control" value="<?php echo $resultVisitor[0]->vis_businessName;  ?>" placeholder="Enter Business Name" name="txtBusinessname" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-7">
                                                                            <div class="input-group input-medium date date-picker" data-date-end-date="+0d" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                                                <input type="text"  value="<?php  if($resultVisitor[0]->vis_dob == '0000-00-00') { echo ''; }else{ echo date(" d-m-Y ",strtotime($resultVisitor[0]->vis_dob)); }?>" class="form-control" readonly name="txtBirtdate" >																				<span class="input-group-btn">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-7">
                                                                            <div class="input-group input-medium date date-picker" data-date-end-date="+0d" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                                                <input type="text" class="form-control" value="<?php if($resultVisitor[0]->vis_anniversaryDate == '0000-00-00') { echo ''; }else{ echo date(" d-m-Y ",strtotime($resultVisitor[0]->vis_anniversaryDate)); } ?>" readonly name="txtAnniversary" >																				<span class="input-group-btn">
																					<button class="btn default" type="button">
																						<i class="fa fa-calendar"></i>
																					</button>
																				</span>
                                                        ...
                                                        <div id="tab5" class="tab-pane fade">
                                                            ...
                                                            <h3 class="block"><?php getLocalkeyword('Additional Info');?></h3>
                                                            <!--														        <div class="col-md-6">-->
                                                            <!--																<div class="form-group">-->
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    for($i=0;$i < count($resultCustom);$i ++)
                                                                    {
                                                                        ...
                                                                        if($type!="textarea")
                                                                        {
                                                                            ...
                                                                            {
                                                                                ?>
                                                                                <input type="<?php echo $type;?>" name="custom_<?php echo $i;?>[]" <?php if(!empty($resultCustom[$i]->cfi_length)){ ?> maxlength="<?php echo $resultCustom[$i]->cfi_length;  } ?> ?>" <?php if($resultCustom[$i]->cfi_category == '1'){ ?> required="required" <?php   } ?> value="<?php echo $resultCustom[$i]->vcf_value;?>" class="form-control">	<?php
                                                                            }
                                                                            else
                                                                            {
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class=" pull-right">
                                                                <button type="submit" name="btnSubmit" class="btn btn-primary"><?php getLocalkeyword('Update');?></button>
