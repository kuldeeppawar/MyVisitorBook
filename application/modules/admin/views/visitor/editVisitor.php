                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="table-toolbar">
                                <div class="row">
                                    ...
                                    <div class="col-md-5  pull-right">
                                        <div class="pull-right">
                                            ...
                                            <ul class="nav navbar-nav pl0 pull-right" style="margin-left: 5px;">
                                                <li class="dropdown dropdown-user burger_menu"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" style="margin-top: 0px;"><i class="fa fa-bars fa-2x" aria-hidden="true"></i>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-default">
                                                        ...
                                                        <li class="options" style="border-bottom: 1px solid #e7ecf1;"><a href="#" onclick="getContactGroup()" style="padding: 5px; margin-top: 5px;"><?php getLocalkeyword('Change Contact Group');?></a></li>
                                            ...
                                            <div id="myModal_group" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal">×</button>
                                                            <h2 class="modal-title text-left">
                                                                <?php getLocalkeyword('Change Contact Group');?>
                                                            </h2>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="portlet-body form">
                                                                <!-- <form role="form"> -->
                                                                <form role="form" id="frmAdd" action="<?php echo base_url()?>admin/visitor/updateGroup" method="post" >
                                                                    <div class="form-body">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <lable> <?php getLocalkeyword('Select Group');?></lable>
                                                                                    <!--                                                                                <select id="selectSearchGroup" name="selectSearchGroup" class="form-control" required="required">-->
                                                                                    <!--                                                                                    <option value="">Select Group</option>-->
                                                                                    <!--                                                                                    --><?php
                                                                                    //                                                                                    for($i=0;$i<count($resultGroup);$i++)
                                                                                    //                                                                                    {
                                                                                    ////                                                                                    ?>
                                                                                    <!--                                                                                        <option value="--><?php //echo $resultGroup[$i]->grp_id_pk; ?><!--">--><?php //echo $resultGroup[$i]->grp_name; ?><!--</option>-->
                                                                                    <!--                                                                                        --><?php
                                                                                    //                                                                                    } ?>
                                                                                    <!--                                                                                </select>-->
                                ...
                                <?php
                                if(count($resultVisitor) <= '0')
                                {
                                    ?>
                                    <div class="col-md-6 pr0">
                                        <span class="pull-right"> <strong><h3>Please Click Add Contact To Add Visitor</h3></strong></span>
                                    </div>
                                    <?php
                                }
                                else{
                                            ...
                                            <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable allchekbox" id="sample_1_2" role="grid" aria-describedby="sample_1_2_info">
                                                ...
                                                for ($i = 0; $i < count($resultVisitor); $i++)
                                                {
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td><?php if(!empty($resultVisitor[$i]->vis_email)) { echo $resultVisitor[$i]->vis_email; } else{ echo '-';} ?></td>
                                                        <td><?php if(!empty($resultVisitor[$i]->vis_businessName)) { echo $resultVisitor[$i]->vis_businessName; } else{ echo '-';} ?></td>
                                                        <td><?php if(!empty($resultVisitor[$i]->cty_name)) { echo $resultVisitor[$i]->cty_name;  } else{ echo '-';} ?></td>
...
<script>
    ...
    function getContactGroup()
    {
        ...
        {
//            alert(branchId);
            $("#clientId").val(branchId);
            var id = 'myModal_group';
            $('#myModal_group').modal('toggle');
//            $("#" + id).fadeIn('slow');
//            myModal_group.fadeIn('slow');
//            $.post("<?php //echo base_url();?>//admin/visitor/getActivatebranch",{branchId:branchId},function(data){
...
//            });
    ...
    function validateOtp(val)
    {
        ...
        if (val == "1" && activePassword != "")
        {
            ...
            $.post("<?php echo base_url(); ?>admin/visitor/validateOtp", {Password:Password11}, function(data){
                if (data == 1)
                {
        ...
        else if (val == "0" && Password1 != "")
        {
            ...
            $.post("<?php echo base_url(); ?>admin/visitor/validateOtp", {Password:Password}, function(data){
                alert(data);
                if (data === 1)
                {
