			...
			<div class="col-md-12">
				<div class=" app-ticket-list">
					<div class="page-bar row">
						<div class="col-md-6">
							<h3 class="page-title">MO Registration</h3>
							<ul class="page-breadcrumb ">
								<li><a href="index.html">Home</a> <i class="fa fa-circle"></i></li>
								<li><span> Settings</span></li>
								<li><span>MO Registration</span></li>
							</ul>
						</div>
								...
								<div class="row">
									...
									<div class="col-md-5 pull-right">
										<div class="pull-right">
											...
											<?php
												if(getAdminAccessRights('mvbMoRegEdit'))
												{
											?>		
														<a href="#"  onclick="getRecord();" class="margin_rgt p_element"><i class="fa fa-pencil-square-o icon_custom" aria-hidden="true" title="Edit"></i></a>
											<?php
												}

												if(getAdminAccessRights('mvbMoRegDelete'))
												{	
											?>		
											...
											<?php
											if(checkPackageRights($this->session->userdata('client_id'),'mo_registration'))
											{
													if(getAdminAccessRights('mvbMoRegAdd'))
													{
													?>
															<div class="btn-group" style="margin-left: 5px;" data-toggle="modal" data-target="#myModal_new1">
																<a id="sample_editable_1_new" class="btn btn-primary"> <i class="fa fa-long-arrow-down"></i> Add New MO
																</a>
															</div>
													<?php
													}
											...
											?>
													<div class="btn-group" style="margin-left: 5px;">
					                                                   <font color="red">You have reached max limit to add mo registration</font> 
					                                </div>
											<?php
											}
											?>		
											<ul class="nav navbar-nav pl0 pull-right" style="margin-left: 5px;">
												<li class="dropdown dropdown-user burger_menu"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" style="margin-top: 0px;"><i class="fa fa-bars fa-2x" aria-hidden="true"></i>
													...
													<ul class="dropdown-menu dropdown-menu-default">
														<li class="options" style="border-bottom: 1px solid #e7ecf1;"><a  onclick="chechCheckbox(1);" href="#" style="padding: 5px;">Active</a></li>
														<li class="options" style="border-bottom: 1px solid #e7ecf1;"><a  onclick="chechCheckbox(0);" href="#" style="padding: 5px;">Deactive</a></li>
													</ul></li>
											</ul>
													...
													<div class="modal-content">
														<div class="modal-header">
															...
															<h2 class="modal-title text-center">
																<i class="fa fa-clone"></i> Add New Mobile No
																</h3>
																...
																<form role="form">
																	<div class="form-body">
																		<div class="row">
																			<div class="col-md-12">
																				<div class="modal-footer">
																					<a href="#" class="btn btn-primary" onclick="getDelete();">Yes</a>
