                ...
                <div class="page-content">
                            ...
                            <div class=" app-ticket-list">
                                ...
                                <div class="page-bar row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <h1 class="page-title">Recent Activities<br>
                  ...
                  <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                      ...
                      <tbody>
                      <?php
                        for($lv=0;$lv<count($recent_activities);$lv++)
                        {
                                  $count_lv=$lv+1;
                      ?>  
                                  <tr class="odd gradeX">
                                    <td><?php echo $count_lv;?></td>
                                    <td><?php echo $recent_activities[$lv]->sysu_name;?></td>
                                    <td><?php echo $recent_activities[$lv]->atl_type;?></td>
                                    <td><?php echo $recent_activities[$lv]->atl_activity_time;?></td>
                                  </tr>
                      <?php
                        }
                      ?>  
