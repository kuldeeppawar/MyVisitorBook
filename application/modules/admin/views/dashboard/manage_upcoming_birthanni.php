<div class="page-content-wrapper">
                ...
                <div class="page-content">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class=" app-ticket-list">
                                ...
                                <div class="page-bar row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <h1 class="page-title">Upcoming Birthday/Upcoming Anniversary<br>
                            ...
                            <ul class="page-breadcrumb ">
                                ...
                                <li>
                                    ...
                                    <span>Upcoming Birthday/Upcoming Anniversary </span>
                                  ...
                                  <div class="form-body">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-4"> 
                                        ...
                                        <!--  <div class="btn-group" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal2"> -->

                                        <div class="btn-group" class="btn btn-info btn-lg">
                  ...
                  <!-- latest visitor table starts here -->
                  ...
                  <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                      ...
                      <tbody>
                      <?php
                        for($lv=0;$lv<count($upcoming_birthanni);$lv++)
                        {
                                  $count_lv=$lv+1;
                      ?>  
                                  <tr class="odd gradeX">
                                    <td><?php echo $count_lv;?></td>
                                    <td><?php echo $upcoming_birthanni[$lv]->vis_firstName.' '.$upcoming_birthanni[$lv]->vis_lastName;?></td>
                                    <td><?php echo $upcoming_birthanni[$lv]->vis_mobile;?></td>
                                    <td><?php echo $upcoming_birthanni[$lv]->event_date;?></td>
                                    <td><?php echo $upcoming_birthanni[$lv]->event_title;?></td>
                                  </tr>
                      <?php
                        }
                      ?>  
