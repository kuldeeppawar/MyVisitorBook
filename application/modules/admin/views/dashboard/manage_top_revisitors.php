                ...
                <div class="page-content">
                            ...
                            <div class=" app-ticket-list">
                                ...
                                <div class="page-bar row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <h1 class="page-title">Top 5 Revisitors<br>
                  ...
                  <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                      ...
                      <tbody>
                      <?php
                        for($lv=0;$lv<count($top_revisitors);$lv++)
                        {
                                  $count_lv=$lv+1;
                      ?>  
                                  <tr class="odd gradeX">
                                    <td><?php echo $count_lv;?></td>
                                    <td><?php echo $top_revisitors[$lv]->vis_firstName.' '.$recent_revisitors[$lv]->vis_lastName;?></td>
                                    <td><?php echo $top_revisitors[$lv]->vis_mobile;?></td>
                                    <td><?php echo $top_revisitors[$lv]->vis_email;?></td>
                                    <!-- <td><?php //echo $top_revisitors[$lv]->created_date;?></td>
                                    <td><?php //echo $top_revisitors[$lv]->rv_purpose;?></td> -->
                                  </tr>
                      <?php
                        }
                      ?>  
