			...
			<div class="col-md-12">
				<div class=" app-ticket-list">
					<div class="page-bar row">
						<div class="col-md-6">
							<h3 class="page-title"><?php getLocalkeyword('Groups Management');?></h3>
							<ul class="page-breadcrumb ">
								<li><a href="<?php echo base_url()?>admin/dashboard"><?php getLocalkeyword('Home');?></a> <i class="fa fa-circle"></i></li>
								<li><span><?php getLocalkeyword('Groups Management');?></span></li>
							</ul>
						</div>
						<div class="col-md-6">
										...
										<ul class="nav navbar-nav pl0">
											<li class="dropdown dropdown-user"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" style="font-size: 18px; padding: 2px 0px;">Recently updated <i class="fa fa-angle-down"></i>
												...
												<ul class="dropdown-menu dropdown-menu-default">
													<li><a href="<?php echo base_url(); ?>admin/groups">All Group</a></li>
                                                    <li><a href="<?php echo base_url(); ?>admin/groups/recentlyUpdated">Recently Updated</a></li>
                                                    <li><a href="<?php echo base_url(); ?>admin/groups/mostViewed">Most Viewed</a></li>
													<li><a href="<?php echo base_url(); ?>admin/groups/getNotUpdatedRecently">Not Update In Last 30 Days</a></li>
												</ul></li>
										</ul>
									</div>
									<div class="col-md-5 pull-right">
										<div class="pull-right">
											<div style="float: left; margin-top: 8px; margin-right: 5px;">
												...
												{
												?>
												<a href="#" onclick="send_sms()" class="margin_rgt p_element1">
												...
												{
												?>
												<a href="#" onclick="send_email()" class="margin_rgt p_element1">
...
<!--                                                    <span class="glyphicon glyphicon-copy"></span>-->
                                                    ...
                                                    <a href="#" data-toggle="modal" data-target="#myModal_copy" title="Clone Group" class="margin_rgt hide_element">
                                                        <span class="glyphicon glyphicon-copy"></span>
                                                    </a>
											 <?php
												}
											...
											<?php 
												if(getAdminAccessRights('mvbSetgIE'))
												{
												?>
											<a href="#" class="p_element111" data-toggle="modal" data-target="#otpimport"><?php getLocalkeyword('Import');?>  </a> 
											  <span class="p_element111">/</span> 
											<a href="#" class="p_element111" data-toggle="modal" data-target="#otp"> 
											  <?php getLocalkeyword('Export');?>
										   </a>
										   <?php } ?>
											<div class="btn-group" style="margin-left: 5px;">
											<?php if(getAdminAccessRights('mvbSetgCg'))
												{
												?>
												<a href="#" id="sample_editable_1_new hvr-float-shadow" class="btn btn-primary" data-toggle="modal" data-target="#myModal"> <?php getLocalkeyword('Create Group');?>
												</a>
											<?php } ?>												
											</div>
												...
												<div class="modal-dialog">
													...
													<div class="modal-content">
														<div class="modal-header">
															...
															<h4 class="modal-title text-left"><?php getLocalkeyword('Enter Password Here');?></h4>
														</div>
														<div class="modal-body">
															...
															<div class="col-md-8 form-group">
																<div class="row">
																	<div class="col-md-5">
																		<label><?php getLocalkeyword('Enter Password');?></label>
																	</div>
																	<div class="col-md-7">
																...
																<!-- <form role="form" > -->
																	<div class="form-body">
																		<div class="row">
																			<div class="col-md-12">
																				<div class="modal-footer">
																					<button   class="btn btn-primary" onclick="deletegroup();"><?php getLocalkeyword('Yes');?></button>
                                            ...
                                            <div id="myModal_copy" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal"></button>
                                                            <h2 class="modal-title text-center">
                                                                <?php getLocalkeyword('Are you sure want to create copy of this group');?> ?
                                                            </h2>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="portlet-body form">
                                                                ...
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="modal-footer">
                                                                                <button   class="btn btn-primary" onclick="createGroup();"><?php getLocalkeyword('Yes');?></button>
                                                                                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php getLocalkeyword('No');?></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
													...
													<div class="modal-content">
														<div class="modal-header">
															...
															<h2 class="modal-title text-left">
																<i class="fa fa-user-plus"></i><?php getLocalkeyword('Create Group');?> 
																<h3></h3>
															</h2>
														</div>
														<div class="modal-body">
																	...
																	<div class="form-body">
																		<div class="row">
																			<div class="col-md-10 pull-left">
																				<div class="form-group">
																					<label><?php getLocalkeyword('Group Name');?> <small>(char limit-20)</small></label><span class="mandatory"> *</span>
																			...
																			<div class="col-md-10 pull-left">
																				<div class="form-group">
																					<label><?php getLocalkeyword('Description');?></label> <span class="mandatory"> *</span>
																			...
																			<div class="row">
																				<div class="input-group col-md-6">
																					<div class="mt-checkbox-list">
																						<label> <input name="chkAdvance" class="" type="checkbox" id="advance" value=""> <?php getLocalkeyword('Advance your search');?>
																						</label>
																					</div>
																				</div>
																				<div class="" style="display: none;" id="advance_form">
																					<div class="row">
																						<div class="col-md-7 pull-left">
																							<div class="form-group">
																								<label><?php getLocalkeyword('Select CSV File');?></label> <input type="file"
																						...
																						<div class="col-md-5 pull-right">
																							<button onclick="getSamplecsv()" type="button" class="btn btn-danger pull-right" style="margin-top: 20px;" >
																								<i class="fa fa-cloud-download"></i><?php getLocalkeyword('Download sample csv');?> 
																							</button>
																						</div>
																					</div>
																				</div>
																		...
																		<div class="modal-footer">
																			...
																			<button type="button" class="btn btn-primary">
																				<i class="fa fa-level-down"></i><?php getLocalkeyword('Import Contacts');?> 
																			</button>
										...
										<table class="table table-striped table-bordered table-hover table-checkable order-column dataTable allchekbox" id="sample_1_2" role="grid" aria-describedby="sample_1_2_info">
											<thead>
												<tr>
													...
													<th><?php getLocalkeyword('Group Name');?></th>
													<th><?php getLocalkeyword('No of Contacts');?></th>
...
function deletegroup(){
	 var count=<?php echo count($resultGroup)?>;
     var groupId;
    ...
    for (var i=1;i<=count;i++)
    {
  	  if($('#chk'+i).is(':checked'))
  	  {
  		groupId=$("#chk"+i).val(); 
  		//console.log(groupId);
  		  $.post("<?php echo base_url();?>admin/groups/deleteGroup",{groupId:groupId},function(data){
    ...
    function createGroup(){
        ...
        for (var i=1;i<=count;i++)
        {
            if($('#chk'+i).is(':checked'))
            {
                groupId=$("#chk"+i).val();
                //console.log(groupId);
                $.post("<?php echo base_url();?>admin/groups/createGroup",{groupId:groupId},function(data){
    ...
    var Password1=$("#txtOtpimport").val();
     ...
     if(val=="1" && activePassword!="")
     {
           var Password=activePassword;
     	   $.post("<?php echo base_url();?>admin/groups/validateOtp",{Password : Password},function(data){
                    if(data==1)
                    {
