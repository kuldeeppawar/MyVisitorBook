          ...
          <div class="col-md-12">
            ...
            <div class=" app-ticket-list">
              ...
              <div class="page-bar row">
                ...
                <div class="col-md-6">
                  ...
                  <ul class="page-breadcrumb ">
                    ...
                    <li> <a href="sms_manage.html">SMS Management</a> <i class="fa fa-circle"></i> </li>

                    <li> <span>Send Bulk SMS</span> </li>
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <form role="form" action="<?php echo base_url(); ?>admin/sms_management/addCampaign" id="CampaignForm" method="POST">
            ...
            <label>
                   ...
                   <!-- <div class="input-group col-md-4">
                    ...
                    <div class="col-md-11">
                      <div class="form-group ">
                        <label>Select SMS content from existing template</label>
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <label>Select SMS Signature </label>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="templateMessage" class="form-control message required" rows="3" placeholder="Type Here" style="height: 152px;" name="txtMessage">
            ...
            <label>
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="modal-footer" style="padding:22px 0px;">
                            ...
                            <a href="<?php echo base_url(); ?>admin/sms_management" class="btn btn-danger">Cancel</a> </div>
...
function getFieldsOptions(value) {
        ...
        $.post("<?php echo base_url();?>admin/sms_management/getFieldsOptions", {
