			...
			<div class="col-md-12">
				<div class=" app-ticket-list">
					<div class="page-bar row">
						<div class="col-md-6">
							<h3 class="page-title"><?php getLocalkeyword('Minimum Balance Reminder');?></h3>
							<ul class="page-breadcrumb ">
								...
								<li><span><?php getLocalkeyword('SMS/Email Reminder');?></span></li>
							</ul>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							<!--<h3 class="page-title " style="margin-top:15px !important;">Minimum Balance Reminder</h3>-->
						</div>
						<form  method="post" action="<?php echo base_url()?>admin/balanceremind/addBalance"> 
							<div class="col-md-2 col-xs-12 col-sm-6">
								<label><?php getLocalkeyword('SMS');?></label> <input type="text"   name="txtSms" size="" class="form-control" placeholder="Value/percent" required="required">
							</div>
							<div class="col-md-2 col-xs-12 col-sm-6">
								<label><?php getLocalkeyword('Email');?></label> <input type="text" size="" name="txtEmail" class="form-control" placeholder="Value/percent" required="required">
							</div>
								<div class="clearfix"></div>
							<div class="col-md-2 col-xs-12 col-sm-6">
								<label><?php getLocalkeyword('Percent');?></label> <input type="radio" name="btnsmsMode" class="form-control" value='0' required="required">
								<label><?php getLocalkeyword('Value');?></label> <input type="radio" name="btnsmsMode" class="form-control" value='1' required="required">
							</div>
							<div class="col-md-2 col-xs-12 col-sm-6">
								<label><?php getLocalkeyword('Percent');?></label> <input type="radio" name="btnemailMode" class="form-control" value='0' required="required">
								<label><?php getLocalkeyword('Value');?></label> <input type="radio" name="btnemailMode" class="form-control" value='1' required="required">
							</div>
							<div class="clearfix"></div>
							<div class="col-md-4 col-xs-12 col-sm-6 mtop10 mt23">
								<?php if(getAdminAccessRights('mvbRemindAdd'))
								{ ?>
								<button type="submit" name="btnSubmit" class="btn btn-primary"><?php getLocalkeyword('Submit');?></button>
								<?php
                                } ?>
								<!-- <button type="button" class="btn btn-danger">Cancel</button> -->
								<a class="btn btn-danger" href="<?php echo base_url(); ?>admin/dashboard" ><?php getLocalkeyword('Cancel');?></a>
							</div>
						</form>
						<div class="clearfix"></div>
						<div class="col-md-5 mtop10">
							<table class="table table-bordered ">
								<thead>
									<tr>
										<th><?php getLocalkeyword('SMS Reminder On');?></th>
										<th><?php getLocalkeyword('Email Reminder On');?></th>
									</tr>
								</thead>
								<tbody>
									<tr><?php if(count($resultBalance)!=0)
									  {?>
										<td><?php echo $resultBalance[0]->balance_smsValue;  if( $resultBalance[0]->balance_smsMode==0){ echo "%";} ?>  <?php getLocalkeyword('SMS');?> </td>
										<td><?php echo $resultBalance[0]->balance_emailValue; if( $resultBalance[0]->balance_emailMode==0){ echo "%";} ?> <?php getLocalkeyword('Email');?> </td>
									  <?php }
									  else
									  {?>
									   <td>----</td>
