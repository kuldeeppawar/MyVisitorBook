...
|
*/
$config['base_url'] = 'http://localhost/mvb/';
...
|
*/
$config['encryption_key'] = 'Think@diFFerent';
...
|
*/
$config['sess_driver'] = 'files';//database in case of server
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = NULL;//ci_sessions in case of server
