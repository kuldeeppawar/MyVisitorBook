				...
				<div class="top-menu pull-right">
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> <img alt=""
                                                                                                                                                                                                        class="img-circle" src="<?php echo base_url();?>themes/assets/layouts/layout/img/avatar3_small.jpg" /> <span class="username username-hide-on-mobile"> <i class="fa fa-angle-down"></i></a> </span><br>
							<ul class="dropdown-menu dropdown-menu-default">
								<li><a href="<?php echo base_url(); ?>admin/myprofile"> <i classm="icon-user"></i> My Profile
								</a></li>
                                                                <li><a href="<?php echo base_url(); ?>admin/myprofile/inbox"> <i class="fa fa-cubes"></i> Inbox
								</a></li>
								<li><a href="<?php echo base_url(); ?>admin/myprofile#Package"> <i class="fa fa-cubes"></i> Package Type
								</a></li>
								<li><a href="<?php echo base_url(); ?>admin/myprofile#myModal"> <i class="fa fa-lock"></i> Change password
								</a></li>
